...
## [4.33.0](https://github.com/toininoi/cli-printing-press/compare/v4.32.1...v4.33.0) (2026-09-12)


### Features

* **auth:** perms-check persisted token reads in generated config.Load / LoadCredentials ([#3596](https://github.com/toininoi/cli-printing-press/issues/3596)) ([63c3dc7](https://github.com/toininoi/cli-printing-press/commit/63c3dc748e0d4fcc1d899c167765ebdee98b3049))
* **cli:** add Apify actor reachability audit ([#2867](https://github.com/toininoi/cli-printing-press/issues/2867)) ([b0c5b0b](https://github.com/toininoi/cli-printing-press/commit/b0c5b0ba1f33c256d9cd47b761da93750eb657a8))
* **cli:** add internal endpoint command fixtures ([#3278](https://github.com/toininoi/cli-printing-press/issues/3278)) ([f945d67](https://github.com/toininoi/cli-printing-press/commit/f945d67023ceff23712d5144ad7412430e15da0e))
* **cli:** add x-pp-example extension to override endpoint help examples ([#3380](https://github.com/toininoi/cli-printing-press/issues/3380)) ([2b45036](https://github.com/toininoi/cli-printing-press/commit/2b4503631b4fad9f04b069c42915a4cb9d7b2d05))
* **cli:** emit SQL-query-endpoint sync by construction (query_sync / x-pp-query) ([#3019](https://github.com/toininoi/cli-printing-press/issues/3019)) ([d700bf2](https://github.com/toininoi/cli-printing-press/commit/d700bf2b30c5c8b82a040c784f994b3c102e8f04))
* **cli:** fold recurring Greptile findings into printed-CLI defaults ([#3005](https://github.com/toininoi/cli-printing-press/issues/3005)) ([11a1752](https://github.com/toininoi/cli-printing-press/commit/11a1752b2eb84a95e62ad95096e9baecca680efe))
* **cli:** four-kind path resolution with credential relocation for generated CLIs ([#2633](https://github.com/toininoi/cli-printing-press/issues/2633)) ([973174b](https://github.com/toininoi/cli-printing-press/commit/973174b6aa848a116039994cce9b6e57987170bd))
* **cli:** self-improving printed CLIs - default-on self-healing learn loop ([#3434](https://github.com/toininoi/cli-printing-press/issues/3434)) ([c19a4ee](https://github.com/toininoi/cli-printing-press/commit/c19a4ee30059997351dd6d735fe59f8d3a3d3912))
* **generator:** add xml response_format for XML-backed APIs ([#3065](https://github.com/toininoi/cli-printing-press/issues/3065)) ([cdf7f4c](https://github.com/toininoi/cli-printing-press/commit/cdf7f4cde83353de2d9389b5b2253e57204ebb9a))
* **generator:** composite-aware ReconcilePartition seen-set + cascade ([#3376](https://github.com/toininoi/cli-printing-press/issues/3376)) ([8d0983b](https://github.com/toininoi/cli-printing-press/commit/8d0983b2dc64f374bde30299ae39c13dd988e99c))
* **generator:** emit CLAUDE.md (@AGENTS.md) for printed CLIs ([#2959](https://github.com/toininoi/cli-printing-press/issues/2959)) ([70cc74c](https://github.com/toininoi/cli-printing-press/commit/70cc74cff3e6b5bdc68a590f876aeefe5e9c1328))
* **generator:** header-driven rate limiter, parallel per-parent fan-out, membership skip, composite path-param fix ([#3429](https://github.com/toininoi/cli-printing-press/issues/3429)) ([d4910e6](https://github.com/toininoi/cli-printing-press/commit/d4910e603317e91831b282d6eba2700e2060409f))
* **generator:** surface sub-resources in MCP context taxonomy ([#3478](https://github.com/toininoi/cli-printing-press/issues/3478)) ([b7598b3](https://github.com/toininoi/cli-printing-press/commit/b7598b3fd75911abf755cdb02edec5b0a3c0d5a1))
* **generator:** sync deletion reconciliation (dependent per-parent mark-and-sweep) ([#3206](https://github.com/toininoi/cli-printing-press/issues/3206)) ([407433a](https://github.com/toininoi/cli-printing-press/commit/407433ac5d85beb3b4b5bd0936bd408e1bf9fe58))
* **generator:** tenant resolver + flat tenant-scoped reconcile ([#3341](https://github.com/toininoi/cli-printing-press/issues/3341)) ([9c3219c](https://github.com/toininoi/cli-printing-press/commit/9c3219c108ab9c64921cad30b04f68c6751e3c31))
* **peloton:** preserve managed oauth generation ([#3609](https://github.com/toininoi/cli-printing-press/issues/3609)) ([3f3c219](https://github.com/toininoi/cli-printing-press/commit/3f3c2190706006faff27e75c28c68c153c3bae5e))
* **pipeline:** emit CLI release ledger skeletons ([#2859](https://github.com/toininoi/cli-printing-press/issues/2859)) ([e13b00d](https://github.com/toininoi/cli-printing-press/commit/e13b00d2481415eca53daedb81ade007b776f821))
* **platform:** enforce fleet output semantics ([#3687](https://github.com/toininoi/cli-printing-press/issues/3687)) ([0e72412](https://github.com/toininoi/cli-printing-press/commit/0e724120277ce6bc52204d7f24014adce0947b4e))
* **platform:** generate multitenancy runtime core ([#3682](https://github.com/toininoi/cli-printing-press/issues/3682)) ([ae1f46b](https://github.com/toininoi/cli-printing-press/commit/ae1f46bafca1bc32417c678d4cfc9bab8dced19e))
* **publish:** lightweight blobless+sparse library clone + force-add MCP source ([#3152](https://github.com/toininoi/cli-printing-press/issues/3152)) ([30d2017](https://github.com/toininoi/cli-printing-press/commit/30d2017a176c566c65fc5b40ed77db01c7ae9c88))
* **skills:** cut retro always-loaded context by 93% ([#3776](https://github.com/toininoi/cli-printing-press/issues/3776)) ([625e876](https://github.com/toininoi/cli-printing-press/commit/625e876ef83e401de6938eb1fa898152b1a01d17))
* **skills:** make Printing Press phases progressive and resumable ([#3723](https://github.com/toininoi/cli-printing-press/issues/3723)) ([5a429c1](https://github.com/toininoi/cli-printing-press/commit/5a429c1da1bdff9e0ec8978cbd093a7b2cfd4743))


### Bug Fixes

* **auth:** pass Chrome cookie path via argv, not python -c ([#4362](https://github.com/toininoi/cli-printing-press/issues/4362)) ([8523d5a](https://github.com/toininoi/cli-printing-press/commit/8523d5ac55dbf01ac710060bd0ef95c86082c035)), closes [#4281](https://github.com/toininoi/cli-printing-press/issues/4281)
* **auth:** same-origin redirect policy for OAuth token exchanges ([#4378](https://github.com/toininoi/cli-printing-press/issues/4378)) ([f3855b7](https://github.com/toininoi/cli-printing-press/commit/f3855b780535680cac89a54b58d955fd0d480dee))
* **catalog:** add health category ([#2868](https://github.com/toininoi/cli-printing-press/issues/2868)) ([9f9ff30](https://github.com/toininoi/cli-printing-press/commit/9f9ff305978e6e65b50b64d398076d4312cc9111))
* **ci:** guard Go toolchain floor drift ([#3512](https://github.com/toininoi/cli-printing-press/issues/3512)) ([03bb829](https://github.com/toininoi/cli-printing-press/commit/03bb8298ef530c9e8a9814fc89f8440cc48ffd0d))
* **ci:** honor latest codeowner review state ([#3068](https://github.com/toininoi/cli-printing-press/issues/3068)) ([33ab3d1](https://github.com/toininoi/cli-printing-press/commit/33ab3d1b441e2f31a82076f616664ced0af64a52))
* **ci:** keep conversation check green on fork review events ([#4599](https://github.com/toininoi/cli-printing-press/issues/4599)) ([2b2d2fe](https://github.com/toininoi/cli-printing-press/commit/2b2d2fee61b94555189f6834020449b3673906cf))
* **ci:** warn when ready-to-merge lacks codeowner approval ([#3061](https://github.com/toininoi/cli-printing-press/issues/3061)) ([49f05bb](https://github.com/toininoi/cli-printing-press/commit/49f05bb783b358971fca9c494ba03a8870d029ce))
* clamp sync page size to pagination param's declared maximum ([#3441](https://github.com/toininoi/cli-printing-press/issues/3441)) ([1df157c](https://github.com/toininoi/cli-printing-press/commit/1df157c421d71f9eaad24c930365d37f92a323a2)), closes [#3440](https://github.com/toininoi/cli-printing-press/issues/3440)
* **cli:** accept object release ledger changes ([#4118](https://github.com/toininoi/cli-printing-press/issues/4118)) ([31f2436](https://github.com/toininoi/cli-printing-press/commit/31f2436e4b7dcc53e3c719b8669bf469a3d2065d))
* **cli:** accept x-tenant-env-var/x-path-template-env-vars at doc root ([#4573](https://github.com/toininoi/cli-printing-press/issues/4573)) ([79b74f2](https://github.com/toininoi/cli-printing-press/commit/79b74f2e947a4da78cc10185ff932d67447fc009))
* **cli:** add examples to jobs commands ([#3356](https://github.com/toininoi/cli-printing-press/issues/3356)) ([a264fd5](https://github.com/toininoi/cli-printing-press/commit/a264fd5eae790ea66a7769e0fe42b940ec8de9b4))
* **cli:** add resumable MCP cursors ([#3230](https://github.com/toininoi/cli-printing-press/issues/3230)) ([8155e8f](https://github.com/toininoi/cli-printing-press/commit/8155e8fcda3346735d62c761bbe17a89bef5a07b))
* **cli:** add timeout helper for novel commands ([#2808](https://github.com/toininoi/cli-printing-press/issues/2808)) ([2767cf3](https://github.com/toininoi/cli-printing-press/commit/2767cf3ba0747140db9652bc6b1508e8c870c7e5))
* **cli:** align auth set-token references with command surface ([#4198](https://github.com/toininoi/cli-printing-press/issues/4198)) ([6dc0cee](https://github.com/toininoi/cli-printing-press/commit/6dc0ceed579f0f6fa42af0ccc1f0313b02e24e6d))
* **cli:** align cobratree MCP tool surface ([#3281](https://github.com/toininoi/cli-printing-press/issues/3281)) ([3270718](https://github.com/toininoi/cli-printing-press/commit/3270718bfd9b2d364c4a966e7833ed11c66c9284))
* **cli:** align dogfood coverage with Cobra semantics ([#4024](https://github.com/toininoi/cli-printing-press/issues/4024)) ([b1b17fd](https://github.com/toininoi/cli-printing-press/commit/b1b17fdd74299a100d98275afb2babc10a5103ed))
* **cli:** align generated auth diagnostics ([#3934](https://github.com/toininoi/cli-printing-press/issues/3934)) ([748c6dc](https://github.com/toininoi/cli-printing-press/commit/748c6dc0c0014331134fb9a6f69ebf969ebf7b53))
* **cli:** align local reads, output modes, and which exits ([#4550](https://github.com/toininoi/cli-printing-press/issues/4550)) ([bb29246](https://github.com/toininoi/cli-printing-press/commit/bb29246f325fc09cecabb6c66d349feed723d756))
* **cli:** align profiler IDField with store date rejection ([#4549](https://github.com/toininoi/cli-printing-press/issues/4549)) ([28fae7a](https://github.com/toininoi/cli-printing-press/commit/28fae7a2e399edc65b612978a431ecc4163a4cf6))
* **cli:** allow adaptive limiter backoff to floor ([#2814](https://github.com/toininoi/cli-printing-press/issues/2814)) ([eac5598](https://github.com/toininoi/cli-printing-press/commit/eac5598e24cb6ea1c623b34ddbce8909ba2ce0ad))
* **cli:** allow credential-free OAuth login probes ([#3624](https://github.com/toininoi/cli-printing-press/issues/3624)) ([57ee95a](https://github.com/toininoi/cli-printing-press/commit/57ee95a28772770d60854f42579d7d61273d9d5a))
* **cli:** allow synthetic phase5 external credential skips ([#2866](https://github.com/toininoi/cli-printing-press/issues/2866)) ([89b27fc](https://github.com/toininoi/cli-printing-press/commit/89b27fcc268ebcc4f69e7da7f904040846de9ebf))
* **cli:** allow ungated MCP tenant gate ([#4171](https://github.com/toininoi/cli-printing-press/issues/4171)) ([9d274a9](https://github.com/toininoi/cli-printing-press/commit/9d274a9153c8c0de80657538ca944e46d68256ec))
* **cli:** anchor scorer target paths and research discovery ([#3872](https://github.com/toininoi/cli-printing-press/issues/3872)) ([4256474](https://github.com/toininoi/cli-printing-press/commit/425647444c4dcc894053fd0275eb690a00bf0a8f))
* **cli:** annotate generated MCP safety metadata ([#3885](https://github.com/toininoi/cli-printing-press/issues/3885)) ([45633b0](https://github.com/toininoi/cli-printing-press/commit/45633b0adcb5d94c0c9fd5de56b586c447845d1b))
* **cli:** apply --limit after HTML extraction, not on raw markup ([#4432](https://github.com/toininoi/cli-printing-press/issues/4432)) ([8719b83](https://github.com/toininoi/cli-printing-press/commit/8719b83dde10b3b7580d7ca527ed503d77c2f330))
* **cli:** apply api key auth prefixes ([#2764](https://github.com/toininoi/cli-printing-press/issues/2764)) ([2e59ab3](https://github.com/toininoi/cli-printing-press/commit/2e59ab31d8dfbb3be2ccb48b717a71eae93838f9))
* **cli:** apply reserved-name gate to novel-feature command names ([#4298](https://github.com/toininoi/cli-printing-press/issues/4298)) ([6870e64](https://github.com/toininoi/cli-printing-press/commit/6870e640aff53c86e1962fb774a3420f17358f51))
* **cli:** attach Authorization header for cookie-typed auth with a real header credential ([#3201](https://github.com/toininoi/cli-printing-press/issues/3201)) ([9a3919d](https://github.com/toininoi/cli-printing-press/commit/9a3919d6f62cfb8c6f76d5f1bbc61be281d227da)), closes [#3200](https://github.com/toininoi/cli-printing-press/issues/3200)
* **cli:** avoid reserved store schema collisions ([#3640](https://github.com/toininoi/cli-printing-press/issues/3640)) ([e279ac8](https://github.com/toininoi/cli-printing-press/commit/e279ac88fe581dd483ed051126c80e83107bdb02))
* **cli:** back off before retrying transient network errors ([#3424](https://github.com/toininoi/cli-printing-press/issues/3424)) ([f4118a3](https://github.com/toininoi/cli-printing-press/commit/f4118a3737489ae11c8f9618031089f3cd7afefa))
* **cli:** backfill empty creator handle on regen + emit store bare-id accessor ([#3232](https://github.com/toininoi/cli-printing-press/issues/3232)) ([104ed22](https://github.com/toininoi/cli-printing-press/commit/104ed220f2adb71e09e9f31ebf99e30bd12b8293))
* **cli:** bind MCP array/object body params natively (WithArray/WithObject) ([#3075](https://github.com/toininoi/cli-printing-press/issues/3075)) ([47897c7](https://github.com/toininoi/cli-printing-press/commit/47897c782d173e94f6c6c54a7ed32029e8cab523))
* **cli:** bind MCP HTTP to loopback by default ([#4192](https://github.com/toininoi/cli-printing-press/issues/4192)) ([142617f](https://github.com/toininoi/cli-printing-press/commit/142617fb4a7011f7b9a7947469f9abded1164af9))
* **cli:** bind scorer proofs to fresh source ([#3928](https://github.com/toininoi/cli-printing-press/issues/3928)) ([8f03678](https://github.com/toininoi/cli-printing-press/commit/8f0367836ecf29854f11bf3000bfdd1b42ceb6f1))
* **cli:** block equals-form MCP root flags ([#3025](https://github.com/toininoi/cli-printing-press/issues/3025)) ([8606544](https://github.com/toininoi/cli-printing-press/commit/86065448654ca4ce7a1d3eb2b1174c6503cff0be))
* **cli:** block MCP filesystem destination flags ([#4212](https://github.com/toininoi/cli-printing-press/issues/4212)) ([20d5058](https://github.com/toininoi/cli-printing-press/commit/20d505805c6de28cca2123207f3e7645662ac7f5))
* **cli:** bound decompressed size in crowd-sniff tarball extraction ([#3787](https://github.com/toininoi/cli-printing-press/issues/3787)) ([20dabea](https://github.com/toininoi/cli-printing-press/commit/20dabeab4e43261afca175425c120b446fef3b2b))
* **cli:** bound MCP SQL execution time and row materialisation ([#4522](https://github.com/toininoi/cli-printing-press/issues/4522)) ([f9c3e16](https://github.com/toininoi/cli-printing-press/commit/f9c3e16754cede12fd29cb54bbef1398870a7e5c))
* **cli:** bound MCP store result envelopes ([#3234](https://github.com/toininoi/cli-printing-press/issues/3234)) ([c5e42bb](https://github.com/toininoi/cli-printing-press/commit/c5e42bbdfd8e320e8c060326eadb26cce4ecff25))
* **cli:** bound sync dogfood and profiler defaults ([#3322](https://github.com/toininoi/cli-printing-press/issues/3322)) ([5858b98](https://github.com/toininoi/cli-printing-press/commit/5858b98a92045b8af68f7597edc43233c45fae2d))
* **cli:** bound typed MCP endpoint responses ([#2771](https://github.com/toininoi/cli-printing-press/issues/2771)) ([a71b3c2](https://github.com/toininoi/cli-printing-press/commit/a71b3c2b4c95c26b4c2a4358ba3db1e6d680b940))
* **cli:** bound workflow archive and keep the store crash-safe ([#4206](https://github.com/toininoi/cli-printing-press/issues/4206)) ([1515265](https://github.com/toininoi/cli-printing-press/commit/151526547a96893232417ef7bd6dcc56989b85c0))
* **cli:** bump Go floor to 1.26.6 ([#4155](https://github.com/toininoi/cli-printing-press/issues/4155)) ([f8b50c9](https://github.com/toininoi/cli-printing-press/commit/f8b50c9390b1b43e373264299546395f8344a703))
* **cli:** bump Go toolchain floor to 1.26.5 ([#3506](https://github.com/toininoi/cli-printing-press/issues/3506)) ([c48a046](https://github.com/toininoi/cli-printing-press/commit/c48a0466e33e1f7ed826a5e64e006e9090384f8c))
* **cli:** bump golang.org/x/net safe floor for GO-2026-5942 ([#4663](https://github.com/toininoi/cli-printing-press/issues/4663)) ([f20fcff](https://github.com/toininoi/cli-printing-press/commit/f20fcff173c7921c861fe282d82aca0fc41acf32))
* **cli:** bump mark3labs/mcp-go template pin to v0.57.0 ([#4050](https://github.com/toininoi/cli-printing-press/issues/4050)) ([904fa58](https://github.com/toininoi/cli-printing-press/commit/904fa58511cda3baaecb5496d91ae266f7977c8f))
* **cli:** calibrate dogfood auth checks ([#3267](https://github.com/toininoi/cli-printing-press/issues/3267)) ([d39ee1c](https://github.com/toininoi/cli-printing-press/commit/d39ee1c05d2118ad5432d2b98496211e9c23a8b6))
* **cli:** calibrate GraphQL generator checks ([#3413](https://github.com/toininoi/cli-printing-press/issues/3413)) ([8601d16](https://github.com/toininoi/cli-printing-press/commit/8601d160dbafdc98bcba6ac0bc3314d8169245a6))
* **cli:** calibrate live dogfood fixtures ([#3290](https://github.com/toininoi/cli-printing-press/issues/3290)) ([5d70d76](https://github.com/toininoi/cli-printing-press/commit/5d70d7606f814642c8f495606f9f43c68d52d735))
* **cli:** centralize MCP output bounds ([#3214](https://github.com/toininoi/cli-printing-press/issues/3214)) ([7f6431c](https://github.com/toininoi/cli-printing-press/commit/7f6431cd0b45d41c521ab799b0ea98bd0f2d3e1d))
* **cli:** chmod legacy cache files on cache-hit reads ([#4471](https://github.com/toininoi/cli-printing-press/issues/4471)) ([2871d6b](https://github.com/toininoi/cli-printing-press/commit/2871d6be9e24621b3ba75e0669d85e662551d1bc))
* **cli:** chmod rewritten cache files to 0600 and skip multipart file IO on --dry-run ([#4429](https://github.com/toininoi/cli-printing-press/issues/4429)) ([c9e942d](https://github.com/toininoi/cli-printing-press/commit/c9e942d12d476ec1c2b0f8e3a5c8c58380b82256)), closes [#4428](https://github.com/toininoi/cli-printing-press/issues/4428) [#4424](https://github.com/toininoi/cli-printing-press/issues/4424)
* **cli:** clamp MCP code-orch search limit before slice. Closes [#3742](https://github.com/toininoi/cli-printing-press/issues/3742). ([#4223](https://github.com/toininoi/cli-printing-press/issues/4223)) ([808a986](https://github.com/toininoi/cli-printing-press/commit/808a9866424b8955d2c5de12d3afecbc77a5d485))
* **cli:** classify bot-wall reachability bodies ([#3279](https://github.com/toininoi/cli-printing-press/issues/3279)) ([b66706e](https://github.com/toininoi/cli-printing-press/commit/b66706e7ab3411c7062fc6de9140e3f83810ad76))
* **cli:** classify DNS failures and expose typed rate-limit errors ([#3919](https://github.com/toininoi/cli-printing-press/issues/3919)) ([b8a95a8](https://github.com/toininoi/cli-printing-press/commit/b8a95a85f5e751931994e1961f39a104a111eb05))
* **cli:** classify GET mutations safely ([#3929](https://github.com/toininoi/cli-printing-press/issues/3929)) ([69bf9bb](https://github.com/toininoi/cli-printing-press/commit/69bf9bb58a684315604fe61da6fb498d13a0fe9d))
* **cli:** classify vendor 401s as credential skips in live dogfood ([#3831](https://github.com/toininoi/cli-printing-press/issues/3831)) ([01782e5](https://github.com/toininoi/cli-printing-press/commit/01782e52053c166787659013a881e34dced11071))
* **cli:** collapse html error bodies ([#4183](https://github.com/toininoi/cli-printing-press/issues/4183)) ([7389a2f](https://github.com/toininoi/cli-printing-press/commit/7389a2f47ce07bf42499badc4dfaa82ac581e06b))
* **cli:** complete novel data-source declarations ([#3719](https://github.com/toininoi/cli-printing-press/issues/3719)) ([a9b35ee](https://github.com/toininoi/cli-printing-press/commit/a9b35eefef99a812ed0c67586047f75cecf5389d))
* **cli:** continue cursor sync across short pages ([#3617](https://github.com/toininoi/cli-printing-press/issues/3617)) ([be192ba](https://github.com/toininoi/cli-printing-press/commit/be192ba687b142bf205cdef80aefd17e1f9317b6))
* **cli:** continue offset pagination after full pages ([#2765](https://github.com/toininoi/cli-printing-press/issues/2765)) ([b994cde](https://github.com/toininoi/cli-printing-press/commit/b994cde6c0e710238a2e78e73c3c5cb0449299e5))
* **cli:** correct generated body request serialization ([#3313](https://github.com/toininoi/cli-printing-press/issues/3313)) ([246113a](https://github.com/toininoi/cli-printing-press/commit/246113acdfdb15db39b1e897f3c85bf6ac589ea3))
* **cli:** correct generated pagination defaults ([#3299](https://github.com/toininoi/cli-printing-press/issues/3299)) ([0bb7820](https://github.com/toininoi/cli-printing-press/commit/0bb78200b1cc520499ecadb9df6fa11dfb8680f4))
* **cli:** correct inaccurate generated help text ([#3811](https://github.com/toininoi/cli-printing-press/issues/3811)) ([727f8bf](https://github.com/toininoi/cli-printing-press/commit/727f8bf9f1bf23383c75b11701f3df220fc2e86c))
* **cli:** correct live dogfood evidence and fixture verdicts ([#3878](https://github.com/toininoi/cli-printing-press/issues/3878)) ([2c9328c](https://github.com/toininoi/cli-printing-press/commit/2c9328cd157a4eeb01614ddb5291e2c3cef5092f))
* **cli:** correct novel scaffold safety hints ([#4172](https://github.com/toininoi/cli-printing-press/issues/4172)) ([023beb3](https://github.com/toininoi/cli-printing-press/commit/023beb35263bbd6c3899cf363bde7ec8c3293a8b))
* **cli:** correct SQLite pragma order to avoid SQLITE_BUSY on concurrent first-run (closes [#2926](https://github.com/toininoi/cli-printing-press/issues/2926)) ([#3165](https://github.com/toininoi/cli-printing-press/issues/3165)) ([82af5ef](https://github.com/toininoi/cli-printing-press/commit/82af5ef6d75e1651617e8dc2806d1851408f850e))
* **cli:** count helper-registered novel commands ([#4018](https://github.com/toininoi/cli-printing-press/issues/4018)) ([516f870](https://github.com/toininoi/cli-printing-press/commit/516f8702a9c9bf44a91f28569c027cf196069a9e))
* **cli:** decouple agent mode from yes ([#4182](https://github.com/toininoi/cli-printing-press/issues/4182)) ([e20b65e](https://github.com/toininoi/cli-printing-press/commit/e20b65e05366981d7bcaa2e8f773e92eef2e8ca4))
* **cli:** dedupe multi-spec duplicate endpoint commands ([#2828](https://github.com/toininoi/cli-printing-press/issues/2828)) ([69a8327](https://github.com/toininoi/cli-printing-press/commit/69a83275029d200d0e3663602918eb27b5b8897d))
* **cli:** dedupe responsePathForResource switch cases ([#3530](https://github.com/toininoi/cli-printing-press/issues/3530)) ([5a23446](https://github.com/toininoi/cli-printing-press/commit/5a2344634f9f26527b21e36028b6995443a581fc))
* **cli:** defang full-shape example credentials in secret-scrubbing reference ([#3480](https://github.com/toininoi/cli-printing-press/issues/3480)) ([e089073](https://github.com/toininoi/cli-printing-press/commit/e089073c6f976f75555ed753925fca92dc9ee6ef))
* **cli:** derive cookie domain from base_url when spec omits cookie_domain ([#3199](https://github.com/toininoi/cli-printing-press/issues/3199)) ([9c9280d](https://github.com/toininoi/cli-printing-press/commit/9c9280d1c9007fd1ac54bba555ea8905d924d64b))
* **cli:** derive generated examples from API models ([#4057](https://github.com/toininoi/cli-printing-press/issues/4057)) ([fd57db4](https://github.com/toininoi/cli-printing-press/commit/fd57db43371ea588f87dd6943e82a547ceaae118))
* **cli:** derive live dogfood fixtures from store ([#2826](https://github.com/toininoi/cli-printing-press/issues/2826)) ([b2f47e5](https://github.com/toininoi/cli-printing-press/commit/b2f47e54b5d280c332040600069f01903a0e51df))
* **cli:** derive manifest, MCPB, and SKILL auth env vars from the credentials the binary reads ([#4431](https://github.com/toininoi/cli-printing-press/issues/4431)) ([c5bd247](https://github.com/toininoi/cli-printing-press/commit/c5bd2474f76516bf09ac7f64e5dac8d16367faf4))
* **cli:** derive sql tool example resource_type from the spec ([#3184](https://github.com/toininoi/cli-printing-press/issues/3184)) ([29659f2](https://github.com/toininoi/cli-printing-press/commit/29659f269504f5b8a8ee1dca70596e18c1e76c67)), closes [#2960](https://github.com/toininoi/cli-printing-press/issues/2960)
* **cli:** derive sync and auth hints from emitted capabilities ([#4487](https://github.com/toininoi/cli-printing-press/issues/4487)) ([93f2c90](https://github.com/toininoi/cli-printing-press/commit/93f2c90f1c2415cfcb5c6f6bbde5fb6ea1d50f92))
* **cli:** disable sqlite mmap to stop SIGBUS store corruption ([#4191](https://github.com/toininoi/cli-printing-press/issues/4191)) ([bd6c65e](https://github.com/toininoi/cli-printing-press/commit/bd6c65e6e8460ebd82a66a2d7a740bd619ca2ec8))
* **cli:** disambiguate collection vs item command stems ([#4294](https://github.com/toininoi/cli-printing-press/issues/4294)) ([62b8950](https://github.com/toininoi/cli-printing-press/commit/62b8950778b1c11bda8bd0b061bf7f03085a65b7))
* **cli:** disambiguate colliding dependent resources ([#3770](https://github.com/toininoi/cli-printing-press/issues/3770)) ([4efaabb](https://github.com/toininoi/cli-printing-press/commit/4efaabbf4c77662eadbf9741efa670d022b8d92f))
* **cli:** do not kill streaming transfers with the default timeout ([#4334](https://github.com/toininoi/cli-printing-press/issues/4334)) ([50ed53c](https://github.com/toininoi/cli-printing-press/commit/50ed53c89a76dbbc2d32cb793e71aa99112a5fe5))
* **cli:** do not preserve files that reintroduce a fresh-generation build break ([#4300](https://github.com/toininoi/cli-printing-press/issues/4300)) ([6c9e737](https://github.com/toininoi/cli-printing-press/commit/6c9e7372c695d9b7c67b8595ac49fdc18c5c45dc))
* **cli:** do not silently sync a default-filtered slice as the whole resource ([#4524](https://github.com/toininoi/cli-printing-press/issues/4524)) ([2f65ebf](https://github.com/toininoi/cli-printing-press/commit/2f65ebfb5b830bdafa30d5344c4ac1f4b91c57b5))
* **cli:** drop dangling ": " from APIError.Error() on empty response body ([#3545](https://github.com/toininoi/cli-printing-press/issues/3545)) ([a2f518f](https://github.com/toininoi/cli-printing-press/commit/a2f518f6825885fc79481c836e433d57318bb557)), closes [#2945](https://github.com/toininoi/cli-printing-press/issues/2945)
* **cli:** emit anchored .gitignore and -trimpath builds ([#4631](https://github.com/toininoi/cli-printing-press/issues/4631)) ([c124faf](https://github.com/toininoi/cli-printing-press/commit/c124faf8d481a86ed674eb8fc76fa826eca8ce64))
* **cli:** emit Cobra Example in novel-feature scaffold ([#3153](https://github.com/toininoi/cli-printing-press/issues/3153)) ([0edc724](https://github.com/toininoi/cli-printing-press/commit/0edc724d372a6c42e48677e465437d55c2bdaee4))
* **cli:** emit JSON dry-run envelope from learn-loop commands ([#3832](https://github.com/toininoi/cli-printing-press/issues/3832)) ([84f5a52](https://github.com/toininoi/cli-printing-press/commit/84f5a52d286239ee06f5b19565671be02fe7d7e0))
* **cli:** emit live dogfood tier annotations ([#3355](https://github.com/toininoi/cli-printing-press/issues/3355)) ([1f65658](https://github.com/toininoi/cli-printing-press/commit/1f6565860a98c69eee20d993a5b5fe9202c942b0))
* **cli:** emit local data layer for syncable APIs ([#2881](https://github.com/toininoi/cli-printing-press/issues/2881)) ([a6da532](https://github.com/toininoi/cli-printing-press/commit/a6da5322b69039beae067d7eeb9a4fd69bf5f099))
* **cli:** emit patch go directives ([#3280](https://github.com/toininoi/cli-printing-press/issues/3280)) ([32329b5](https://github.com/toininoi/cli-printing-press/commit/32329b5571a28033d65ef3880c7951e6bf93d4a5))
* **cli:** emit runnable command examples ([#3722](https://github.com/toininoi/cli-printing-press/issues/3722)) ([dbe6a62](https://github.com/toininoi/cli-printing-press/commit/dbe6a624d02269d601d3e75a4e78bd9474f2002c))
* **cli:** emit sync since-filter in UTC (Z), not a local offset ([#3672](https://github.com/toininoi/cli-printing-press/issues/3672)) ([fae90f6](https://github.com/toininoi/cli-printing-press/commit/fae90f6f348a8dbe20511c2ce3a3ab6f97c55add))
* **cli:** emit valid Windows SQLite file URIs ([#4031](https://github.com/toininoi/cli-printing-press/issues/4031)) ([86b8ce0](https://github.com/toininoi/cli-printing-press/commit/86b8ce0604da3320624d1664679f68ed472524be))
* **cli:** enable verify live mode from explicit --env-var ([#4606](https://github.com/toininoi/cli-printing-press/issues/4606)) ([6b9914b](https://github.com/toininoi/cli-printing-press/commit/6b9914bc9c861b4daabdedd7c92191e6b054b6fd))
* **cli:** encode path params as single segments ([#4184](https://github.com/toininoi/cli-printing-press/issues/4184)) ([d49c457](https://github.com/toininoi/cli-printing-press/commit/d49c457592c2f5579ea0c57a24df40bb7f36111e))
* **client:** bind cookie credentials to https canonical host for every token source ([#4363](https://github.com/toininoi/cli-printing-press/issues/4363)) ([ea85b49](https://github.com/toininoi/cli-printing-press/commit/ea85b490e79f850299b6c688efa2fb9e085aa4f9))
* **client:** treat scheme as part of the origin before replaying auth credentials ([#4292](https://github.com/toininoi/cli-printing-press/issues/4292)) ([1eecefc](https://github.com/toininoi/cli-printing-press/commit/1eecefc4b9a9d1279e027614b765fefe4a177a63))
* **cli:** exit non-zero on missing positional and unknown subcommand ([#3633](https://github.com/toininoi/cli-printing-press/issues/3633)) ([06446fc](https://github.com/toininoi/cli-printing-press/commit/06446fc16373dd7573ffe39c8d9619afe73c43b8))
* **cli:** expose a queryable bare id for parent-keyed typed tables ([#4434](https://github.com/toininoi/cli-printing-press/issues/4434)) ([1de9e66](https://github.com/toininoi/cli-printing-press/commit/1de9e66a3a3c2a979bd8064492dfba3cd67d2618))
* **cli:** extract items from map-keyed collections ([#4335](https://github.com/toininoi/cli-printing-press/issues/4335)) ([81d5a6b](https://github.com/toininoi/cli-printing-press/commit/81d5a6b65803d4a011299cb6167ca2f247f19113))
* **cli:** fail dogfood on missing data-source strategy ([#2805](https://github.com/toininoi/cli-printing-press/issues/2805)) ([0f3d988](https://github.com/toininoi/cli-printing-press/commit/0f3d9887c9c10914ed083547631e36c83778bb17))
* **cli:** fail loud when a JSON endpoint returns HTML ([#4391](https://github.com/toininoi/cli-printing-press/issues/4391)) ([a1494f3](https://github.com/toininoi/cli-printing-press/commit/a1494f36bfca21186943ec1ecec5ab986fb54679))
* **cli:** fail sync integrity and hydration aliasing ([#4185](https://github.com/toininoi/cli-printing-press/issues/4185)) ([801de21](https://github.com/toininoi/cli-printing-press/commit/801de2134513cbceae17ffe277f5522fdf7587bb))
* **cli:** fail workflow archive when every resource errors ([#4410](https://github.com/toininoi/cli-printing-press/issues/4410)) ([28c43fa](https://github.com/toininoi/cli-printing-press/commit/28c43fa99ad1b74907a6dfd5c660b40704c52f08))
* **cli:** filter telemetry hosts in browser sniff ([#2865](https://github.com/toininoi/cli-printing-press/issues/2865)) ([08864e4](https://github.com/toininoi/cli-printing-press/commit/08864e4169a3c6ab40ebecf643773815ea93a96a))
* **cli:** fix feedback/teach annotations and doctor gosec name ([#4648](https://github.com/toininoi/cli-printing-press/issues/4648)) ([2dde45a](https://github.com/toininoi/cli-printing-press/commit/2dde45afa3c08f4409760b74764eacb98723b3ce))
* **cli:** flag oauth2 refresh missing client id ([#2902](https://github.com/toininoi/cli-printing-press/issues/2902)) ([4ceaada](https://github.com/toininoi/cli-printing-press/commit/4ceaada8c78f7d5dc7ab541f55b47803581c6e15))
* **cli:** floor x/sys&gt;=v0.46.0, x/crypto&gt;=v0.53.0, quic-go&gt;=v0.60.0 + 0700 dirs in printed CLIs ([#3017](https://github.com/toininoi/cli-printing-press/issues/3017)) ([a164251](https://github.com/toininoi/cli-printing-press/commit/a164251692068ad3d04bcb257837f496edfd5319))
* **cli:** follow generated pagination cursors safely ([#3601](https://github.com/toininoi/cli-printing-press/issues/3601)) ([4c9300f](https://github.com/toininoi/cli-printing-press/commit/4c9300f82f6fdef404099949add7adf0ef35eed8))
* **cli:** format MCP numeric params without exponent ([#2767](https://github.com/toininoi/cli-printing-press/issues/2767)) ([ad36c24](https://github.com/toininoi/cli-printing-press/commit/ad36c2468ec0ecaf5b06a946ebed32663aa5cb34))
* **cli:** gate generated command surfaces ([#3333](https://github.com/toininoi/cli-printing-press/issues/3333)) ([b15220f](https://github.com/toininoi/cli-printing-press/commit/b15220f0d8bcbc1bb07fb793d71f22b923b5450e))
* **cli:** gate nested required fields by parent ([#3585](https://github.com/toininoi/cli-printing-press/issues/3585)) ([7f7e0c4](https://github.com/toininoi/cli-printing-press/commit/7f7e0c4e9bb657877ba4621b11cbb6f5b8870023))
* **cli:** gate partial failure helpers by emitted callers ([#3470](https://github.com/toininoi/cli-printing-press/issues/3470)) ([f5a4795](https://github.com/toininoi/cli-printing-press/commit/f5a4795d7394725ecd675d509429ef7820fc6832))
* **cli:** gate zero-sync data surfaces ([#3659](https://github.com/toininoi/cli-printing-press/issues/3659)) ([ecf2493](https://github.com/toininoi/cli-printing-press/commit/ecf249395db2d003b7c7642f203411df21fb9fe2))
* **cli:** generate complete Basic credential tests ([#3724](https://github.com/toininoi/cli-printing-press/issues/3724)) ([9a539cb](https://github.com/toininoi/cli-printing-press/commit/9a539cb2a624b9a6d6d7323a2fee5d349a275ad4))
* **cli:** guard read-only mcp positional write sinks ([#3037](https://github.com/toininoi/cli-printing-press/issues/3037)) ([cbcec34](https://github.com/toininoi/cli-printing-press/commit/cbcec34513dba1cb65666bb203273a34e7394cd1))
* **cli:** guard regen against stale Printing Press binaries ([#2758](https://github.com/toininoi/cli-printing-press/issues/2758)) ([d0e9b32](https://github.com/toininoi/cli-printing-press/commit/d0e9b32abd601faf13f5b4530f6daea7879edb75))
* **cli:** guard shipcheck live mutations ([#4173](https://github.com/toininoi/cli-printing-press/issues/4173)) ([c63890c](https://github.com/toininoi/cli-printing-press/commit/c63890ca8603114367f0383bbbc571def8a5e6b0))
* **cli:** guard unresolved path params ([#3027](https://github.com/toininoi/cli-printing-press/issues/3027)) ([f8476f5](https://github.com/toininoi/cli-printing-press/commit/f8476f52b0fad3a301c0d56a29f20416aa792ca9))
* **cli:** handle auth-none generation metadata ([#4113](https://github.com/toininoi/cli-printing-press/issues/4113)) ([91fb730](https://github.com/toininoi/cli-printing-press/commit/91fb730a7e8898cfda630cfa793bef58d46efaf4))
* **cli:** handle generated collection envelopes consistently ([#3920](https://github.com/toininoi/cli-printing-press/issues/3920)) ([04b9208](https://github.com/toininoi/cli-printing-press/commit/04b92085b2b60387b68d58e4524c231b1cb732d6))
* **cli:** handle HAL pagination envelopes and size page parameters ([#3651](https://github.com/toininoi/cli-printing-press/issues/3651)) ([6c57441](https://github.com/toininoi/cli-printing-press/commit/6c574414e26cae4ab457c23fa6daba2db62b0c68))
* **cli:** harden browser sniff HAR quality ([#3271](https://github.com/toininoi/cli-printing-press/issues/3271)) ([7d7a695](https://github.com/toininoi/cli-printing-press/commit/7d7a695d79e8580094e0171f83a077facf6e529b))
* **cli:** harden browser-session auth imports ([#3348](https://github.com/toininoi/cli-printing-press/issues/3348)) ([95529b7](https://github.com/toininoi/cli-printing-press/commit/95529b721ef96f23595b15bd9e560663c550dc1d))
* **cli:** harden force regen merge ([#2812](https://github.com/toininoi/cli-printing-press/issues/2812)) ([cc3692f](https://github.com/toininoi/cli-printing-press/commit/cc3692ff27195ac37e90ef7f72228c27041e8b03))
* **cli:** harden generated auth client retries ([#3248](https://github.com/toininoi/cli-printing-press/issues/3248)) ([aa05aea](https://github.com/toininoi/cli-printing-press/commit/aa05aeabc217fb0bce50fbf3bd166a6faf707197))
* **cli:** harden generated auth runtime ([#3298](https://github.com/toininoi/cli-printing-press/issues/3298)) ([103c25a](https://github.com/toininoi/cli-printing-press/commit/103c25a231564dcf744521224465c13c7c643df6))
* **cli:** harden generated credential writes ([#4028](https://github.com/toininoi/cli-printing-press/issues/4028)) ([e09c898](https://github.com/toininoi/cli-printing-press/commit/e09c898a733418b4418b9d7ba6d591a1a85dd089))
* **cli:** harden generated local-store behavior ([#3658](https://github.com/toininoi/cli-printing-press/issues/3658)) ([81b4570](https://github.com/toininoi/cli-printing-press/commit/81b457094c714a65238611012b3fa33e2b28ccbc))
* **cli:** harden generated MCP handlers ([#3586](https://github.com/toininoi/cli-printing-press/issues/3586)) ([339fdc6](https://github.com/toininoi/cli-printing-press/commit/339fdc6fb245357f8ba492e2fca6e59b2cc4e59a))
* **cli:** harden generated read and search extraction ([#3321](https://github.com/toininoi/cli-printing-press/issues/3321)) ([99a9e41](https://github.com/toininoi/cli-printing-press/commit/99a9e4103b3c3c604e0cc96cbe7245e426ddf6d7))
* **cli:** harden generated SQLite concurrency ([#4138](https://github.com/toininoi/cli-printing-press/issues/4138)) ([ee01a6e](https://github.com/toininoi/cli-printing-press/commit/ee01a6e66556080c0beeaf3243f3cce8a9787865))
* **cli:** harden generated store file permissions ([#3613](https://github.com/toininoi/cli-printing-press/issues/3613)) ([459a867](https://github.com/toininoi/cli-printing-press/commit/459a867a6a3ac62cc7bf1e65c448ee6ef556d9d0))
* **cli:** harden generated sync identity runtime ([#3312](https://github.com/toininoi/cli-printing-press/issues/3312)) ([37f640b](https://github.com/toininoi/cli-printing-press/commit/37f640b9d88e58ee6be82e042ef54ecc41e214bc))
* **cli:** harden generator correctness ([#3251](https://github.com/toininoi/cli-printing-press/issues/3251)) ([24294a1](https://github.com/toininoi/cli-printing-press/commit/24294a14f0b82a3209fb4afb1dd86db6c2cadcfa))
* **cli:** harden happy-path argv handling ([#3926](https://github.com/toininoi/cli-printing-press/issues/3926)) ([8887152](https://github.com/toininoi/cli-printing-press/commit/8887152487a3e057a09cb3fd75d89fa3fc7205a7))
* **cli:** harden provenance and sniff edge cases ([#3320](https://github.com/toininoi/cli-printing-press/issues/3320)) ([4a259d6](https://github.com/toininoi/cli-printing-press/commit/4a259d670a3f1d2d0d9a015237ee0efe9b0b9c14))
* **cli:** harden publish artifact staging ([#3414](https://github.com/toininoi/cli-printing-press/issues/3414)) ([4a2b023](https://github.com/toininoi/cli-printing-press/commit/4a2b02329e71e64cc7ffe14ff9af569d0dfa3495))
* **cli:** harden publish packaging ([#3250](https://github.com/toininoi/cli-printing-press/issues/3250)) ([6c0b5d8](https://github.com/toininoi/cli-printing-press/commit/6c0b5d85ab5d82d4a67f4073278833d34bf4fb1e))
* **cli:** harden publish secret and PII scans ([#3270](https://github.com/toininoi/cli-printing-press/issues/3270)) ([79bddbb](https://github.com/toininoi/cli-printing-press/commit/79bddbbc4fbd9860199072b581c402e8141912ed))
* **cli:** harden recipe and reprint flows ([#3252](https://github.com/toininoi/cli-printing-press/issues/3252)) ([83f6a45](https://github.com/toininoi/cli-printing-press/commit/83f6a4534a9091f0397d727d7361be98f49bf453))
* **cli:** harden response-path store extraction ([#3300](https://github.com/toininoi/cli-printing-press/issues/3300)) ([b8d9b21](https://github.com/toininoi/cli-printing-press/commit/b8d9b21ccea71e12726f193dcc5cca4c25df1613))
* **cli:** harden scorer verify gates ([#3319](https://github.com/toininoi/cli-printing-press/issues/3319)) ([3ded211](https://github.com/toininoi/cli-printing-press/commit/3ded211ba2f8ea287ee8b2af900dccfd18c832d3))
* **cli:** harden validation gates ([#3249](https://github.com/toininoi/cli-printing-press/issues/3249)) ([a9bbdd4](https://github.com/toininoi/cli-printing-press/commit/a9bbdd48c3a80df10fd236508886865f1e13c979))
* **cli:** hide credential suffixes in generated redaction ([#3875](https://github.com/toininoi/cli-printing-press/issues/3875)) ([c1b6bdb](https://github.com/toininoi/cli-printing-press/commit/c1b6bdbb27d8488d15ed38baf0674c4c98d29521))
* **cli:** honest bearer auth format, novel creds, and JWT exp on status/doctor ([#4618](https://github.com/toininoi/cli-printing-press/issues/4618)) ([495350f](https://github.com/toininoi/cli-printing-press/commit/495350fef7bb05d32e26cc566cc95bd11af979d5))
* **cli:** honest doctor auth reporting and env advertising ([#4488](https://github.com/toininoi/cli-printing-press/issues/4488)) ([b15cae1](https://github.com/toininoi/cli-printing-press/commit/b15cae19ec543bef77aaa35caf17af2c950b8f1a))
* **cli:** honest empty csv/plain, which index, doctor HTML, promoted examples ([#4634](https://github.com/toininoi/cli-printing-press/issues/4634)) ([4b3847a](https://github.com/toininoi/cli-printing-press/commit/4b3847af4d4db02489ac32680c2ee2b0fc87bedf))
* **cli:** honor --deliver for binary responses ([#4547](https://github.com/toininoi/cli-printing-press/issues/4547)) ([199ae28](https://github.com/toininoi/cli-printing-press/commit/199ae286f6c102984245b0bc912d1583d87ea389))
* **cli:** honor auth preference in dogfood manifest ([#2878](https://github.com/toininoi/cli-printing-press/issues/2878)) ([99e73ac](https://github.com/toininoi/cli-printing-press/commit/99e73ac5ce882d8776bae92585d2b5eed7efacb4))
* **cli:** honor directly-held env bearer in OAuth2 authcode AuthHeader ([#3490](https://github.com/toininoi/cli-printing-press/issues/3490)) ([7301f67](https://github.com/toininoi/cli-printing-press/commit/7301f67b91723e2d40288bec8d60010bd69c33c2))
* **cli:** honor explicit quiet for teach JSON output ([#3648](https://github.com/toininoi/cli-printing-press/issues/3648)) ([61041c5](https://github.com/toininoi/cli-printing-press/commit/61041c5784e6fd2f4b8304c9d4b737193ee250f3))
* **cli:** honor generated sync pagination contracts ([#4062](https://github.com/toininoi/cli-printing-press/issues/4062)) ([99d1fb3](https://github.com/toininoi/cli-printing-press/commit/99d1fb34883de00e6a9b4a29dedd01e1705a5861))
* **cli:** honor live dogfood happy args overlays ([#3264](https://github.com/toininoi/cli-printing-press/issues/3264)) ([f9dbafa](https://github.com/toininoi/cli-printing-press/commit/f9dbafa467559bf4bc3f2b1326ec093a9564227c))
* **cli:** honor non-JSON request and response media types ([#3754](https://github.com/toininoi/cli-printing-press/issues/3754)) ([ac2ed6d](https://github.com/toininoi/cli-printing-press/commit/ac2ed6de07778736c165c2377c64202610ae4001))
* **cli:** honor output format flags across generated commands ([#3235](https://github.com/toininoi/cli-printing-press/issues/3235)) ([43033b0](https://github.com/toininoi/cli-printing-press/commit/43033b037980ad76023ded4cc24fcd52b7970ef9))
* **cli:** honor paginated HTML responses ([#3627](https://github.com/toininoi/cli-printing-press/issues/3627)) ([3713207](https://github.com/toininoi/cli-printing-press/commit/3713207fd5ebd749df51481adaa8be787622283e))
* **cli:** honor plan-mode dry runs ([#3410](https://github.com/toininoi/cli-printing-press/issues/3410)) ([93c3442](https://github.com/toininoi/cli-printing-press/commit/93c344255fbf63e8943e7d95beb339735fb136c6))
* **cli:** honor pp:typed-exit-codes in live dogfood and complete learn-loop annotations ([#3556](https://github.com/toininoi/cli-printing-press/issues/3556)) ([19ffc5d](https://github.com/toininoi/cli-printing-press/commit/19ffc5d129054c4d612a11067f4155c7e313e2eb))
* **cli:** hydrate scalar-id sync resources ([#3515](https://github.com/toininoi/cli-printing-press/issues/3515)) ([72335ba](https://github.com/toininoi/cli-printing-press/commit/72335baf69685bb2f5b44780f7b6f831517b1d51))
* **cli:** ignore dangling OpenAPI security refs ([#3026](https://github.com/toininoi/cli-printing-press/issues/3026)) ([fc3e340](https://github.com/toininoi/cli-printing-press/commit/fc3e34098790009a630b6c57ee0c118e4859cc15))
* **cli:** implement PKCE for secretless OAuth authorization-code login ([#3460](https://github.com/toininoi/cli-printing-press/issues/3460)) ([6e43fd5](https://github.com/toininoi/cli-printing-press/commit/6e43fd5d5dc458fa91b910aa9e4ddb4efb1dfacb))
* **cli:** improve phase five and skill validation feedback ([#3288](https://github.com/toininoi/cli-printing-press/issues/3288)) ([b9aa369](https://github.com/toininoi/cli-printing-press/commit/b9aa369b03978ee279a0beafc157abea2b0d819b))
* **cli:** improve which ranking and Google Discovery generation ([#3476](https://github.com/toininoi/cli-printing-press/issues/3476)) ([800d893](https://github.com/toininoi/cli-printing-press/commit/800d8936129bb9f8f644f32f957e0ba73d6947fc))
* **cli:** index 3-letter all-caps acronyms in generated FTS ([#3185](https://github.com/toininoi/cli-printing-press/issues/3185)) ([e2a9b50](https://github.com/toininoi/cli-printing-press/commit/e2a9b50142aa996036cd17589ba162e7e8d59f38)), closes [#3098](https://github.com/toininoi/cli-printing-press/issues/3098)
* **cli:** isolate explicit config credentials ([#3771](https://github.com/toininoi/cli-printing-press/issues/3771)) ([e3bcfb2](https://github.com/toininoi/cli-printing-press/commit/e3bcfb29795faeee030e618845e8e05c1479b305))
* **cli:** isolate generated tests from real home paths ([#3874](https://github.com/toininoi/cli-printing-press/issues/3874)) ([b0ed85d](https://github.com/toininoi/cli-printing-press/commit/b0ed85d13424dc77c160c12adc99d2cd879b4e79))
* **cli:** JSON-string body params send the decoded value, not the raw flag string ([#3812](https://github.com/toininoi/cli-printing-press/issues/3812)) ([c4d2fc0](https://github.com/toininoi/cli-printing-press/commit/c4d2fc0b0332ffab680fd5f0fe7fdee3d63c1dfb))
* **cli:** kebab-case auto-synthesized command examples ([#4558](https://github.com/toininoi/cli-printing-press/issues/4558)) ([6f52212](https://github.com/toininoi/cli-printing-press/commit/6f52212b1a349b51882a7a67768a7dff5778b637))
* **cli:** keep --all and empty --csv results complete ([#4548](https://github.com/toininoi/cli-printing-press/issues/4548)) ([9f7e107](https://github.com/toininoi/cli-printing-press/commit/9f7e107f45a3d41659a002e84b78b6ed92eaa07c))
* **cli:** keep browser-http ALPN on HTTP/1.1 ([#3599](https://github.com/toininoi/cli-printing-press/issues/3599)) ([3623e16](https://github.com/toininoi/cli-printing-press/commit/3623e16ebc7560346cf5b090800e0c2bb5b49ba0))
* **cli:** keep env OAuth secrets out of config.toml ([#4393](https://github.com/toininoi/cli-printing-press/issues/4393)) ([e0e0107](https://github.com/toininoi/cli-printing-press/commit/e0e01070f0d1e35563d3a2145d7ffa2c536ef449))
* **cli:** keep hand-corrected MCP command mirrors during dogfood ([#4439](https://github.com/toininoi/cli-printing-press/issues/4439)) ([f9a58df](https://github.com/toininoi/cli-printing-press/commit/f9a58df4fa54733678981b00deb1b13686a6bc31))
* **cli:** keep in-use imports and take fresh bodies on regen-merge ([#4505](https://github.com/toininoi/cli-printing-press/issues/4505)) ([042bdd3](https://github.com/toininoi/cli-printing-press/commit/042bdd3a6e0e05e54ef7a5c090f4ba298e132a4c))
* **cli:** keep local datastore MCP off HTTP endpoints ([#3411](https://github.com/toininoi/cli-printing-press/issues/3411)) ([d9a82a9](https://github.com/toininoi/cli-printing-press/commit/d9a82a9433bdb8bb1895c56a1b07e988d505d063))
* **cli:** keep non-JSON resources out of default sync ([#4525](https://github.com/toininoi/cli-printing-press/issues/4525)) ([17c349e](https://github.com/toininoi/cli-printing-press/commit/17c349ecfad4facf996e6e934c3a5620c389ef47))
* **cli:** keep novel implementations and fix novel hook order ([#4474](https://github.com/toininoi/cli-printing-press/issues/4474)) ([c08d3bc](https://github.com/toininoi/cli-printing-press/commit/c08d3bc274f95daf005729149a3765d1460e6b19))
* **cli:** keep POST read/search/list response bodies ([#4274](https://github.com/toininoi/cli-printing-press/issues/4274)) ([2fb6337](https://github.com/toininoi/cli-printing-press/commit/2fb6337b595fb39651b1bfbcf2de131dac44dcd6))
* **cli:** keep store upserts for id-less and detail-rich resources ([#4472](https://github.com/toininoi/cli-printing-press/issues/4472)) ([b0fb907](https://github.com/toininoi/cli-printing-press/commit/b0fb907fddbd35f4fd038b24bef66c1fff894b3f))
* **cli:** keep verify --json stdout pure with --fix ([#4593](https://github.com/toininoi/cli-printing-press/issues/4593)) ([2546928](https://github.com/toininoi/cli-printing-press/commit/254692886ee19f8ebdbbe8a27ad9cd88fe508062)), closes [#4352](https://github.com/toininoi/cli-printing-press/issues/4352)
* **cli:** keep which specificity from zeroing single-token leaves ([#4557](https://github.com/toininoi/cli-printing-press/issues/4557)) ([4daed52](https://github.com/toininoi/cli-printing-press/commit/4daed52b7ebaf0b413c6cb4545214130e1f76ab8))
* **cli:** key response-path unwrap on resource+endpoint identity ([#4301](https://github.com/toininoi/cli-printing-press/issues/4301)) ([54360bd](https://github.com/toininoi/cli-printing-press/commit/54360bd9714e03b5189d2769e4bdf0324d8beb8c))
* **cli:** lock promote runs ValidatePatchRecords ([#4630](https://github.com/toininoi/cli-printing-press/issues/4630)) ([8e8b276](https://github.com/toininoi/cli-printing-press/commit/8e8b276400d89c0299f0e706c426719accee70cc))
* **cli:** make BLE backend opt-in for default builds ([#2766](https://github.com/toininoi/cli-printing-press/issues/2766)) ([c5c8c93](https://github.com/toininoi/cli-printing-press/commit/c5c8c931d8cbdab61088de457e5a2e91c12384e0))
* **cli:** make browser-clearance auth login succeed as generated ([#4615](https://github.com/toininoi/cli-printing-press/issues/4615)) ([3215c1e](https://github.com/toininoi/cli-printing-press/commit/3215c1e7533bc3dc2da861f3cabb16dc3cc63a95))
* **cli:** make default User-Agent overridable via &lt;ENV_PREFIX&gt;_USER_AGENT ([#4006](https://github.com/toininoi/cli-printing-press/issues/4006)) ([c06697a](https://github.com/toininoi/cli-printing-press/commit/c06697a890c3730899e04b4a8e2c3e2f3393a470))
* **cli:** make dogfood --live + promote gate cookie-auth aware ([#3107](https://github.com/toininoi/cli-printing-press/issues/3107)) ([b343f4d](https://github.com/toininoi/cli-printing-press/commit/b343f4da15acea3c9d3307a6ea27af2ebf879239))
* **cli:** make generated auth hints scheme-aware ([#2875](https://github.com/toininoi/cli-printing-press/issues/2875)) ([8222735](https://github.com/toininoi/cli-printing-press/commit/822273573f2a9a0c8572a2839cdbc97241cc5e55))
* **cli:** make generated store list zero limit unbounded ([#2762](https://github.com/toininoi/cli-printing-press/issues/2762)) ([76326a9](https://github.com/toininoi/cli-printing-press/commit/76326a9d366878bc71b0382c3da78f409c9eff0b))
* **cli:** make generated synonym registration race-safe ([#3752](https://github.com/toininoi/cli-printing-press/issues/3752)) ([4dfbcab](https://github.com/toininoi/cli-printing-press/commit/4dfbcabd4d12ddc88fb3af5a49b9956d0291963d))
* **cli:** make go install work on Go 1.27 ([#4649](https://github.com/toininoi/cli-printing-press/issues/4649)) ([102578c](https://github.com/toininoi/cli-printing-press/commit/102578c08cf1e99b0edf3f6426f37dc57f5f590d))
* **cli:** make graphql latest-only choose newest page ([#2823](https://github.com/toininoi/cli-printing-press/issues/2823)) ([c3e044b](https://github.com/toininoi/cli-printing-press/commit/c3e044ba0bc3ddc1de75b27e0abd45398e13d667))
* **cli:** mcpb optional env defaults and honest MCP intent positionals ([#4617](https://github.com/toininoi/cli-printing-press/issues/4617)) ([7d05e40](https://github.com/toininoi/cli-printing-press/commit/7d05e401daeb4e5096d317e282aad3d287b5b890))
* **cli:** narrow Cloudflare HTML challenge detection ([#3717](https://github.com/toininoi/cli-printing-press/issues/3717)) ([1b0611a](https://github.com/toininoi/cli-printing-press/commit/1b0611a7d9f1e5c255f31815d06479c9ffd3f9e2))
* **cli:** normalize brand-named auth env vars ([#3595](https://github.com/toininoi/cli-printing-press/issues/3595)) ([91539d1](https://github.com/toininoi/cli-printing-press/commit/91539d107808ebe3f0c87f5e957a68d7183e6543))
* **cli:** normalize hyphenated parent FK for typed-table sync ([#4413](https://github.com/toininoi/cli-printing-press/issues/4413)) ([691921b](https://github.com/toininoi/cli-printing-press/commit/691921b6da5eceb76c4ba032706300b9901fd2b1))
* **cli:** normalize live gate example branch ([#2996](https://github.com/toininoi/cli-printing-press/issues/2996)) ([2752d9b](https://github.com/toininoi/cli-printing-press/commit/2752d9bb46800bfdc33b3f2e1e910be1e1ab60e9))
* **cli:** normalize response envelopes before pagination ([#3862](https://github.com/toininoi/cli-printing-press/issues/3862)) ([aaa2cca](https://github.com/toininoi/cli-printing-press/commit/aaa2ccae55e0b2c87761c639362d8dc6202d8386))
* **cli:** normalize store read-only branch ([#3047](https://github.com/toininoi/cli-printing-press/issues/3047)) ([543cfc5](https://github.com/toininoi/cli-printing-press/commit/543cfc54ee7c70a9391474f5085ba80a48c623e2))
* **cli:** normalize text spec checksums ([#4264](https://github.com/toininoi/cli-printing-press/issues/4264)) ([4bfd0ec](https://github.com/toininoi/cli-printing-press/commit/4bfd0eccce5cd252d55b5f1e99a305bb6cafc211))
* **cli:** order path-param positionals by URL path, not declaration order ([#3390](https://github.com/toininoi/cli-printing-press/issues/3390)) ([a64d829](https://github.com/toininoi/cli-printing-press/commit/a64d8295b60e9d6cd13bf27c94a9f6687501ae0c)), closes [#3369](https://github.com/toininoi/cli-printing-press/issues/3369)
* **cli:** pace generated MCP clients ([#2809](https://github.com/toininoi/cli-printing-press/issues/2809)) ([477ed2f](https://github.com/toininoi/cli-printing-press/commit/477ed2f458232d938f775e163d6374570bb0b0fe))
* **cli:** package manifest-selected manuscripts safely ([#3582](https://github.com/toininoi/cli-printing-press/issues/3582)) ([16b21f6](https://github.com/toininoi/cli-printing-press/commit/16b21f66411e9908677acd4a34e99b846bdb0ef3))
* **cli:** parse protocol-relative server URLs ([#3625](https://github.com/toininoi/cli-printing-press/issues/3625)) ([a4c888d](https://github.com/toininoi/cli-printing-press/commit/a4c888d81df1acd7df30ce07cefd42161970d013))
* **cli:** parse SQLite CURRENT_TIMESTAMP in ParseStoredTime ([#4224](https://github.com/toininoi/cli-printing-press/issues/4224)) ([813788f](https://github.com/toininoi/cli-printing-press/commit/813788f45defa60b0b7643f8a0b9a72517e00696))
* **cli:** persist OAuth token expiry in generated credentials ([#3533](https://github.com/toininoi/cli-printing-press/issues/3533)) ([e73f2f9](https://github.com/toininoi/cli-printing-press/commit/e73f2f9fe8d86e640ed72cd15ea1d33131b1c2f1))
* **cli:** persist rotating refresh tokens across live dogfood ([#4594](https://github.com/toininoi/cli-printing-press/issues/4594)) ([92b601d](https://github.com/toininoi/cli-printing-press/commit/92b601dcb2c9050d4cca5dd381d661b0eeb2e5ca))
* **cli:** persist scorer gates and live polish status ([#3314](https://github.com/toininoi/cli-printing-press/issues/3314)) ([161be9c](https://github.com/toininoi/cli-printing-press/commit/161be9c836c4f6368c784153566e992759997cf3))
* **cli:** pin go directive to a library-safe floor ([#4485](https://github.com/toininoi/cli-printing-press/issues/4485)) ([5a1332f](https://github.com/toininoi/cli-printing-press/commit/5a1332f6048f3b64e11eef32b20af87e3e096661))
* **cli:** pin golang.org/x/text above GO-2026-5970 ([#4268](https://github.com/toininoi/cli-printing-press/issues/4268)) ([993667e](https://github.com/toininoi/cli-printing-press/commit/993667e18296f91efab690b555881c10ae297340))
* **cli:** prefer credential URLs in auth inference ([#3641](https://github.com/toininoi/cli-printing-press/issues/3641)) ([2a159c2](https://github.com/toininoi/cli-printing-press/commit/2a159c271c4d5a8dfc6448d2d3967a0083ea5902))
* **cli:** prefer list response_path for sync resource unwrap ([#4595](https://github.com/toininoi/cli-printing-press/issues/4595)) ([032c0a2](https://github.com/toininoi/cli-printing-press/commit/032c0a2e2cf2b7581522aadb188c91dd5ad6a4af))
* **cli:** preserve .git across generate --force ([#4646](https://github.com/toininoi/cli-printing-press/issues/4646)) ([c5cee5e](https://github.com/toininoi/cli-printing-press/commit/c5cee5ea3a46620b2d52926c0657d896ac545d05))
* **cli:** preserve .git on lock promote in-place ([#4194](https://github.com/toininoi/cli-printing-press/issues/4194)) ([5568e71](https://github.com/toininoi/cli-printing-press/commit/5568e7116f1a47a4cf2f2646241ae2e8052e9605))
* **cli:** preserve authored generated descriptions ([#2870](https://github.com/toininoi/cli-printing-press/issues/2870)) ([a97cddc](https://github.com/toininoi/cli-printing-press/commit/a97cddc7d769dc88b529d76b1adc3afededa7898))
* **cli:** preserve CLI and MCP command reachability ([#3731](https://github.com/toininoi/cli-printing-press/issues/3731)) ([1669d17](https://github.com/toininoi/cli-printing-press/commit/1669d176e1309c40b813334c5b4412c107368d6a))
* **cli:** preserve compact and select projection payloads ([#4135](https://github.com/toininoi/cli-printing-press/issues/4135)) ([d74ddbf](https://github.com/toininoi/cli-printing-press/commit/d74ddbfa96bb205b43be968404e00d407e4ef11e))
* **cli:** preserve declared request parameters ([#3867](https://github.com/toininoi/cli-printing-press/issues/3867)) ([ea20450](https://github.com/toininoi/cli-printing-press/commit/ea204500a17f403f63badf7fd8cffd0f094fd6cf))
* **cli:** preserve deep hierarchy sync identity ([#3729](https://github.com/toininoi/cli-printing-press/issues/3729)) ([973d760](https://github.com/toininoi/cli-printing-press/commit/973d760cced23bdeadcf8056e0685f7f118a9f79))
* **cli:** preserve dependent child-parent store rows ([#2761](https://github.com/toininoi/cli-printing-press/issues/2761)) ([28674a5](https://github.com/toininoi/cli-printing-press/commit/28674a5e80a0a57dd01579e80c29efd72c8e174a))
* **cli:** preserve dry-run read provenance and cache boundaries ([#3769](https://github.com/toininoi/cli-printing-press/issues/3769)) ([775feb8](https://github.com/toininoi/cli-printing-press/commit/775feb8a6c8bcb798ca81a9edc590cac3849d312))
* **cli:** preserve empty-result output formats ([#3863](https://github.com/toininoi/cli-printing-press/issues/3863)) ([8909c21](https://github.com/toininoi/cli-printing-press/commit/8909c219efe1bcd60bde18980cbbaa62e29fc7b3))
* **cli:** preserve generated credential aliases ([#3603](https://github.com/toininoi/cli-printing-press/issues/3603)) ([facf37a](https://github.com/toininoi/cli-printing-press/commit/facf37a65c6c2303105def21c2f86480f7a71081))
* **cli:** preserve generated pagination contracts ([#4115](https://github.com/toininoi/cli-printing-press/issues/4115)) ([fd69e7f](https://github.com/toininoi/cli-printing-press/commit/fd69e7f0135bea8889e825b86800d98344de7772))
* **cli:** preserve generated query params ([#3240](https://github.com/toininoi/cli-printing-press/issues/3240)) ([65db052](https://github.com/toininoi/cli-printing-press/commit/65db0525c0ce40045dfb24ba6cdfc3bc141b77a1))
* **cli:** preserve generated workflow boundaries ([#3877](https://github.com/toininoi/cli-printing-press/issues/3877)) ([5d542c4](https://github.com/toininoi/cli-printing-press/commit/5d542c42b1348341f4f6dff08cf6539a7d64a34d))
* **cli:** preserve git metadata in regen-merge apply ([#3110](https://github.com/toininoi/cli-printing-press/issues/3110)) ([c2d050d](https://github.com/toininoi/cli-printing-press/commit/c2d050de6f0896c3eda2fdf417b014f9e119d7d7))
* **cli:** preserve hand-authored files on generate --force ([#4509](https://github.com/toininoi/cli-printing-press/issues/4509)) ([545122b](https://github.com/toininoi/cli-printing-press/commit/545122bc45deaa57b9f25d1edb66b1ccf28bc640))
* **cli:** preserve hand-authored MCP behavior during mcp-sync ([#4507](https://github.com/toininoi/cli-printing-press/issues/4507)) ([ec23ea0](https://github.com/toininoi/cli-printing-press/commit/ec23ea0c54aae321f8ae779f01e674b32237990f))
* **cli:** preserve hierarchical path parameter slashes ([#3654](https://github.com/toininoi/cli-printing-press/issues/3654)) ([949c807](https://github.com/toininoi/cli-printing-press/commit/949c8072386128ad372278f7aba777253b4794a8))
* **cli:** preserve implemented novel command scaffolds ([#3309](https://github.com/toininoi/cli-printing-press/issues/3309)) ([e847c1d](https://github.com/toininoi/cli-printing-press/commit/e847c1d319567cbe84565753d07fa64469ef4d5f))
* **cli:** preserve legacy reprint version layout ([#3111](https://github.com/toininoi/cli-printing-press/issues/3111)) ([ddadd9b](https://github.com/toininoi/cli-printing-press/commit/ddadd9b4125bd250cc71969f3cf198867f9f3e36))
* **cli:** preserve lock promote artifacts ([#3887](https://github.com/toininoi/cli-printing-press/issues/3887)) ([b09c786](https://github.com/toininoi/cli-printing-press/commit/b09c7864f8ec9a401225ea86511f9b50f1432730))
* **cli:** preserve mcp mirror positional args ([#3332](https://github.com/toininoi/cli-printing-press/issues/3332)) ([a2f0842](https://github.com/toininoi/cli-printing-press/commit/a2f084239b445ef0ebba98ac98a128993722d8e5))
* **cli:** preserve mcp-sync intent parity and reject version skew ([#4146](https://github.com/toininoi/cli-printing-press/issues/4146)) ([8b2c361](https://github.com/toininoi/cli-printing-press/commit/8b2c361e37e50e6688ce21ac3bcdfd10a47c7432)), closes [#4134](https://github.com/toininoi/cli-printing-press/issues/4134)
* **cli:** preserve multi-spec merge integrity ([#4059](https://github.com/toininoi/cli-printing-press/issues/4059)) ([6230ab6](https://github.com/toininoi/cli-printing-press/commit/6230ab6238ae24847c3c486a771ae776c8662406))
* **cli:** preserve novel command reachability ([#3886](https://github.com/toininoi/cli-printing-press/issues/3886)) ([cf5b57a](https://github.com/toininoi/cli-printing-press/commit/cf5b57ae4b941f8dafa86aa0a2b582b4ebdc0532))
* **cli:** preserve novel command test ownership ([#3277](https://github.com/toininoi/cli-printing-press/issues/3277)) ([26af081](https://github.com/toininoi/cli-printing-press/commit/26af08161edff63128fd5202424646db9bd2160c))
* **cli:** preserve novel features across mcp-sync ([#4666](https://github.com/toininoi/cli-printing-press/issues/4666)) ([0878fb0](https://github.com/toininoi/cli-printing-press/commit/0878fb0d9e825abdb9f52d206fa3bd94b4a1cc8f))
* **cli:** preserve OAuth bearer auth headers ([#4112](https://github.com/toininoi/cli-printing-press/issues/4112)) ([1a5f6ca](https://github.com/toininoi/cli-printing-press/commit/1a5f6cac7105fbdbfe722a1af4da72893a15dabf))
* **cli:** preserve pagination response declarations ([#3890](https://github.com/toininoi/cli-printing-press/issues/3890)) ([0371213](https://github.com/toininoi/cli-printing-press/commit/03712132717bb98b08f59120ccebaee3f8d09d75))
* **cli:** preserve reprint runtime version layout ([#3389](https://github.com/toininoi/cli-printing-press/issues/3389)) ([39fa634](https://github.com/toininoi/cli-printing-press/commit/39fa63410ea6b3c7d5ac04b926897864c7e84776))
* **cli:** preserve standalone force regen files ([#4174](https://github.com/toininoi/cli-printing-press/issues/4174)) ([4b3569f](https://github.com/toininoi/cli-printing-press/commit/4b3569f6b47539686a2b4e0cf16f3de890f3cade))
* **cli:** preserve sync watermarks across pagination caps ([#3932](https://github.com/toininoi/cli-printing-press/issues/3932)) ([23fdeb4](https://github.com/toininoi/cli-printing-press/commit/23fdeb445133fc6a79e7f5a99e8825eca1f6c7a7))
* **cli:** preserve unverified scorer coverage ([#3933](https://github.com/toininoi/cli-printing-press/issues/3933)) ([f41c5c8](https://github.com/toininoi/cli-printing-press/commit/f41c5c829fb748b1acbb6d16716ad56aa66ff619))
* **cli:** preserve Windows companion CLI fallback ([#2876](https://github.com/toininoi/cli-printing-press/issues/2876)) ([a113f4c](https://github.com/toininoi/cli-printing-press/commit/a113f4c2b95e63d8289f34d0bb8b370cc22a6828))
* **cli:** preserve zero-valued integer query params ([#4143](https://github.com/toininoi/cli-printing-press/issues/4143)) ([5e77ac1](https://github.com/toininoi/cli-printing-press/commit/5e77ac1b1795ca9154f715f3c84eb1860a5bae6e))
* **cli:** prevent derived command surface collisions ([#3757](https://github.com/toininoi/cli-printing-press/issues/3757)) ([ecddccf](https://github.com/toininoi/cli-printing-press/commit/ecddccf91cd857d6facf340f89dc82435808552b))
* **cli:** prevent docs-scraper endpoint-name collisions from dropping routes ([#3789](https://github.com/toininoi/cli-printing-press/issues/3789)) ([6192b39](https://github.com/toininoi/cli-printing-press/commit/6192b397027feec07662fc7a93c3cd40493045b8))
* **cli:** prevent silent pagination truncation ([#4026](https://github.com/toininoi/cli-printing-press/issues/4026)) ([b230409](https://github.com/toininoi/cli-printing-press/commit/b230409226e32616403048ffad71da9ce34cf22d))
* **cli:** prevent unsafe request retries ([#3615](https://github.com/toininoi/cli-printing-press/issues/3615)) ([cf0458a](https://github.com/toininoi/cli-printing-press/commit/cf0458a835d05caf6bd70e6fb0cad38735576c3f))
* **cli:** project wrapped-array output ([#3239](https://github.com/toininoi/cli-printing-press/issues/3239)) ([3c25b3e](https://github.com/toininoi/cli-printing-press/commit/3c25b3ef223f12bb993be06d0e7e1c42e191f745))
* **cli:** protect auth-destructive GET dogfood probes ([#4017](https://github.com/toininoi/cli-printing-press/issues/4017)) ([7169348](https://github.com/toininoi/cli-printing-press/commit/7169348927ca7b35530329047a6468824c4bfae0))
* **cli:** prune phantom which index entries ([#3115](https://github.com/toininoi/cli-printing-press/issues/3115)) ([fa188e4](https://github.com/toininoi/cli-printing-press/commit/fa188e4eb2bf10e9b9ecfff0b5b27874dcdbf2e1))
* **cli:** prune single-tenant mirrors; do not mark truncated walks complete. ([#4247](https://github.com/toininoi/cli-printing-press/issues/4247)) ([47bf39b](https://github.com/toininoi/cli-printing-press/commit/47bf39b4529c17e42b1ceae68cf50e2c2a341d69))
* **cli:** qualify FTS ORDER BY rank to the FTS table ([#3095](https://github.com/toininoi/cli-printing-press/issues/3095)) ([541d7e8](https://github.com/toininoi/cli-printing-press/commit/541d7e8340e7838c19ccfdb6f9fc1731b8f72978))
* **cli:** re-mint client_credentials on 401 and unwrap mutation-output envelopes ([#4392](https://github.com/toininoi/cli-printing-press/issues/4392)) ([3c9a017](https://github.com/toininoi/cli-printing-press/commit/3c9a017c92d69a0b64189a70c5c641980f2cacf0))
* **cli:** read-only store opens and stop PreRun RW migration ([#4619](https://github.com/toininoi/cli-printing-press/issues/4619)) ([df7d298](https://github.com/toininoi/cli-printing-press/commit/df7d298369264f960b5b310a76ed440b37dfaa4b))
* **cli:** rebuild stale live dogfood binaries ([#3579](https://github.com/toininoi/cli-printing-press/issues/3579)) ([7a5b90e](https://github.com/toininoi/cli-printing-press/commit/7a5b90e624a302df159e45f4d2ec91a052cd0671))
* **cli:** recall identifier-only teaches and keep journal sessions ([#4443](https://github.com/toininoi/cli-printing-press/issues/4443)) ([71c6995](https://github.com/toininoi/cli-printing-press/commit/71c6995ff43c6e0a33ad84792dc00c13ac18ecf5))
* **cli:** recognize camelCase stemUid as resource primary key ([#4412](https://github.com/toininoi/cli-printing-press/issues/4412)) ([fb3b43e](https://github.com/toininoi/cli-printing-press/commit/fb3b43efa184c69ba118368d05c30fe97dc29b67))
* **cli:** recognize MongoDB _id as a stable store identifier ([#3895](https://github.com/toininoi/cli-printing-press/issues/3895)) ([473ecd5](https://github.com/toininoi/cli-printing-press/commit/473ecd51204981f1965986e6bae371fce3b7cc21))
* **cli:** redact credential JSON keys in artifacts ([#3034](https://github.com/toininoi/cli-printing-press/issues/3034)) ([133e97d](https://github.com/toininoi/cli-printing-press/commit/133e97dc8d79c8ed1eb25e18fad94d254c13e046))
* **cli:** redact credential tokens from proof samples ([#3580](https://github.com/toininoi/cli-printing-press/issues/3580)) ([3cc7089](https://github.com/toininoi/cli-printing-press/commit/3cc708940b522f485503c9f4a987603018cabe6b))
* **cli:** redact learn query logs and stop shell interpolation ([#4560](https://github.com/toininoi/cli-printing-press/issues/4560)) ([160accf](https://github.com/toininoi/cli-printing-press/commit/160accf8a2d62392ae7805c767dc2f772c8f2629))
* **cli:** redact live dogfood auth samples ([#4055](https://github.com/toininoi/cli-printing-press/issues/4055)) ([64a1368](https://github.com/toininoi/cli-printing-press/commit/64a1368ce1b68d3f63944390dc40410ac03fc315))
* **cli:** reduce scorer dogfood false failures ([#3344](https://github.com/toininoi/cli-printing-press/issues/3344)) ([eafd6ba](https://github.com/toininoi/cli-printing-press/commit/eafd6ba9a1390a0a81a6d72cd691ea83bad46eb2))
* **cli:** refresh staged artifacts before promote ([#3612](https://github.com/toininoi/cli-printing-press/issues/3612)) ([947b1e9](https://github.com/toininoi/cli-printing-press/commit/947b1e97328ecf07a94b68e72c1a9340b83c21eb))
* **cli:** regen-merge keep addNovelCommandIfAbsent registrations ([#4632](https://github.com/toininoi/cli-printing-press/issues/4632)) ([8a341f4](https://github.com/toininoi/cli-printing-press/commit/8a341f4ec4ca88d235bdfa6c6b93473fb10a41bd))
* **cli:** register novel framework commands and manifest entries ([#4139](https://github.com/toininoi/cli-printing-press/issues/4139)) ([a529a81](https://github.com/toininoi/cli-printing-press/commit/a529a81f148489005e5b518667ba3d0d93c6d425))
* **cli:** register parent-scoped sync templates ([#3331](https://github.com/toininoi/cli-printing-press/issues/3331)) ([f1510cd](https://github.com/toininoi/cli-printing-press/commit/f1510cd13504a21299ef914f2f4606ddce9f7372))
* **cli:** reject HTTPS-to-HTTP redirects when fetching crowd-sniff tarballs ([#3788](https://github.com/toininoi/cli-printing-press/issues/3788)) ([f324f79](https://github.com/toininoi/cli-printing-press/commit/f324f7926bac2951d269c898ed75763078064328))
* **cli:** reject multi-statement sql mcp queries ([#2811](https://github.com/toininoi/cli-printing-press/issues/2811)) ([c3d4e1e](https://github.com/toininoi/cli-printing-press/commit/c3d4e1e646c5b8d0e3737ca50f62ccebf714e355))
* **cli:** reject unusable auth declarations ([#3728](https://github.com/toininoi/cli-printing-press/issues/3728)) ([471a3c3](https://github.com/toininoi/cli-printing-press/commit/471a3c3fb227092ad407e66871592928c4775d13))
* **cli:** remove generated 1Password resolver coupling ([#3915](https://github.com/toininoi/cli-printing-press/issues/3915)) ([4b2640f](https://github.com/toininoi/cli-printing-press/commit/4b2640f26f5a2ad5f38fb78099ddd721863048ab))
* **cli:** remove vendor-specific profile wording ([#3430](https://github.com/toininoi/cli-printing-press/issues/3430)) ([ea8d6fb](https://github.com/toininoi/cli-printing-press/commit/ea8d6fbe8fec8d0c5e658ace31c1f89c6d0168a1))
* **cli:** repair credential load refusal and merge state ([#4205](https://github.com/toininoi/cli-printing-press/issues/4205)) ([1e8fe39](https://github.com/toininoi/cli-printing-press/commit/1e8fe3934fc3d0dd4f074287004f8d0633818fcb))
* **cli:** repair generated which scoring ([#4056](https://github.com/toininoi/cli-printing-press/issues/4056)) ([c87935a](https://github.com/toininoi/cli-printing-press/commit/c87935a56da525442cb1befb096ae7c7ea86bcc1))
* **cli:** report generated batch failures ([#3616](https://github.com/toininoi/cli-printing-press/issues/3616)) ([065aee4](https://github.com/toininoi/cli-printing-press/commit/065aee414805de4601850bbfacc6e3ad35cb09ef))
* **cli:** report live provenance and document exit code 6 ([#4561](https://github.com/toininoi/cli-printing-press/issues/4561)) ([2b505d9](https://github.com/toininoi/cli-printing-press/commit/2b505d9ccd23196cddadafdd384f77cb5919138b))
* **cli:** report lock stale only when the lock is actually stale ([#4506](https://github.com/toininoi/cli-printing-press/issues/4506)) ([e416dd4](https://github.com/toininoi/cli-printing-press/commit/e416dd45c0a39faebf0d8f5876d988992b374a39)), closes [#4468](https://github.com/toininoi/cli-printing-press/issues/4468)
* **cli:** reprint from current novel_features, not the last built set ([#4521](https://github.com/toininoi/cli-printing-press/issues/4521)) ([32d0c5a](https://github.com/toininoi/cli-printing-press/commit/32d0c5acc12f3a2dcfbf5abc5149f8d2e3f00022)), closes [#3532](https://github.com/toininoi/cli-printing-press/issues/3532)
* **cli:** require patched Go generator release ([#3610](https://github.com/toininoi/cli-printing-press/issues/3610)) ([1f77334](https://github.com/toininoi/cli-printing-press/commit/1f77334ddc5a76add34b65e91ce675fe9ccd77df))
* **cli:** required-param guards honor resolved flag values ([#4473](https://github.com/toininoi/cli-printing-press/issues/4473)) ([107521a](https://github.com/toininoi/cli-printing-press/commit/107521a64cf764c68672c7f87a4a3f14dd7fa8be))
* **cli:** rewrite go.mod and name tokens on publish rename ([#4333](https://github.com/toininoi/cli-printing-press/issues/4333)) ([1a4ece3](https://github.com/toininoi/cli-printing-press/commit/1a4ece3c849ba1affa1ad05431500d57acaf8fc4))
* **cli:** route browser cookie auth through jar path ([#3408](https://github.com/toininoi/cli-printing-press/issues/3408)) ([d30d066](https://github.com/toininoi/cli-printing-press/commit/d30d0662468577cf7f70c7504b1c28e49cc90fc7))
* **cli:** route generated error output and preserve no-op semantics ([#4121](https://github.com/toininoi/cli-printing-press/issues/4121)) ([eae5b3d](https://github.com/toininoi/cli-printing-press/commit/eae5b3d70bf83038440e07e06b10f7a3d9c34fd9))
* **cli:** route local collection reads through list store ([#3113](https://github.com/toininoi/cli-printing-press/issues/3113)) ([2c8c293](https://github.com/toininoi/cli-printing-press/commit/2c8c293227dfd1b66628eee7ccb1dbe5cc58c6c2))
* **cli:** route shipcheck verify for HTML sync stubs ([#2825](https://github.com/toininoi/cli-printing-press/issues/2825)) ([59f3574](https://github.com/toininoi/cli-printing-press/commit/59f3574c5e500d4b4ac302c4b68c1e09548052d5))
* **cli:** route Substack writer endpoints globally ([#3018](https://github.com/toininoi/cli-printing-press/issues/3018)) ([66a6c8a](https://github.com/toininoi/cli-printing-press/commit/66a6c8aa6b5f8c40f92a55c4a478a6417b16c458))
* **cli:** run clientHooks on generated MCP clients ([#4523](https://github.com/toininoi/cli-printing-press/issues/4523)) ([eaf73df](https://github.com/toininoi/cli-printing-press/commit/eaf73dfd6b6a9bf3d5851c2655bd8bb722fa2747))
* **cli:** sandbox generated tests and verify the sandbox holds ([#3692](https://github.com/toininoi/cli-printing-press/issues/3692)) ([6ac616f](https://github.com/toininoi/cli-printing-press/commit/6ac616f02adc5479373e55cad0f72344e66f22fe)), closes [#3690](https://github.com/toininoi/cli-printing-press/issues/3690)
* **cli:** sanitize generated local search ([#2770](https://github.com/toininoi/cli-printing-press/issues/2770)) ([5c58694](https://github.com/toininoi/cli-printing-press/commit/5c5869413a2369ebc3d0e11f24d28e221fb75edc))
* **cli:** sanitize insights similar FTS queries ([#4213](https://github.com/toininoi/cli-printing-press/issues/4213)) ([2b69deb](https://github.com/toininoi/cli-printing-press/commit/2b69deb5d2c9d738b7694e50ac7598ae3d37ab5d))
* **cli:** sanitize MCP property keys and emit deepObject query params ([#3825](https://github.com/toininoi/cli-printing-press/issues/3825)) ([4790085](https://github.com/toininoi/cli-printing-press/commit/4790085a00b7eed904d42c6f3b5c2897c878000a))
* **cli:** scaffold Google service-account JWT bearer auth ([#3865](https://github.com/toininoi/cli-printing-press/issues/3865)) ([ff27ab1](https://github.com/toininoi/cli-printing-press/commit/ff27ab187ef797a9a4cc1c3a3f5e4ee3fd17addd))
* **cli:** scope browser credentials by host ([#4107](https://github.com/toininoi/cli-printing-press/issues/4107)) ([1a1a65f](https://github.com/toininoi/cli-printing-press/commit/1a1a65f1c9dfa71e971422d57ffa7c8b80688f71))
* **cli:** scope global params from env ([#2827](https://github.com/toininoi/cli-printing-press/issues/2827)) ([95b099e](https://github.com/toininoi/cli-printing-press/commit/95b099e530c075fd2333309eec509a5c958e9692))
* **cli:** scope the default store path to the credential ([#4204](https://github.com/toininoi/cli-printing-press/issues/4204)) ([c5bc30e](https://github.com/toininoi/cli-printing-press/commit/c5bc30e4423c04927cd385d27fbf1115b133f8fc))
* **cli:** scrub generated terminal output ([#3614](https://github.com/toininoi/cli-printing-press/issues/3614)) ([f839f1c](https://github.com/toininoi/cli-printing-press/commit/f839f1c2a2f7b398cc5c0e2cfca646d0d20b0dc6))
* **cli:** scrub generated terminal output ([#3614](https://github.com/toininoi/cli-printing-press/issues/3614)) ([c732ccc](https://github.com/toininoi/cli-printing-press/commit/c732ccc146a1c2f3bdbb453b12c8a00e4bf4219e))
* **cli:** scrub JWT-form GitHub installation tokens ([#4607](https://github.com/toininoi/cli-printing-press/issues/4607)) ([d63da1e](https://github.com/toininoi/cli-printing-press/commit/d63da1ef71b4271460178bc0ed38b9194befa9cc))
* **cli:** seed POST-query sync first page with id-walk filter ([#4411](https://github.com/toininoi/cli-printing-press/issues/4411)) ([507f207](https://github.com/toininoi/cli-printing-press/commit/507f2071da5a96bfdf2ef5b13ecdfb7de093e8f7))
* **cli:** send spec-declared query param defaults from sync ([#4343](https://github.com/toininoi/cli-printing-press/issues/4343)) ([2880827](https://github.com/toininoi/cli-printing-press/commit/2880827b458df48d9bcb38035930a99c1f3acb8a))
* **cli:** send x-pp-sync-walker query-param parent keys ([#4271](https://github.com/toininoi/cli-printing-press/issues/4271)) ([61dd4bf](https://github.com/toininoi/cli-printing-press/commit/61dd4bfd82b5600f8d47c68f114145c0b6b59589)), closes [#3816](https://github.com/toininoi/cli-printing-press/issues/3816)
* **cli:** serialize OpenAPI array query params ([#3583](https://github.com/toininoi/cli-printing-press/issues/3583)) ([e4389b4](https://github.com/toininoi/cli-printing-press/commit/e4389b4e2080bc52a5fd71cb7e5c0925dbcbfd48))
* **cli:** set multipart file-part Content-Type from extension ([#4440](https://github.com/toininoi/cli-printing-press/issues/4440)) ([22bd536](https://github.com/toininoi/cli-printing-press/commit/22bd53640a048c62424f25f66665f1d53b02ee0a))
* **cli:** skill dry-run templates match writeDryRun ([#4546](https://github.com/toininoi/cli-printing-press/issues/4546)) ([2fec32e](https://github.com/toininoi/cli-printing-press/commit/2fec32e34d9f7400722cd59ecb68836dfddb39a8))
* **cli:** skip colliding novel command stubs ([#2773](https://github.com/toininoi/cli-printing-press/issues/2773)) ([5931c78](https://github.com/toininoi/cli-printing-press/commit/5931c781db17e186b4376ae6bd86afda1509f452))
* **cli:** skip idless resources in default sync ([#2830](https://github.com/toininoi/cli-printing-press/issues/2830)) ([50054e1](https://github.com/toininoi/cli-printing-press/commit/50054e1ebb03f74aab70f51df28cdae53c4f8206))
* **cli:** skip JSON guard on binary response bodies ([#4293](https://github.com/toininoi/cli-printing-press/issues/4293)) ([ac1bd4a](https://github.com/toininoi/cli-printing-press/commit/ac1bd4abd3ebfbcfe909a2017602ec3df9f42215))
* **cli:** skip live dogfood placeholder fixture reads ([#3036](https://github.com/toininoi/cli-printing-press/issues/3036)) ([bd338f1](https://github.com/toininoi/cli-printing-press/commit/bd338f11a34abeac22c8b1a2040792b722cff8fd))
* **cli:** skip MCP tools for sub-resource parent groups ([#4245](https://github.com/toininoi/cli-printing-press/issues/4245)) ([de5bd88](https://github.com/toininoi/cli-printing-press/commit/de5bd88432f4830bd1ba38c22a92c24650c4402e))
* **cli:** skip novel wiring on command file collisions ([#3024](https://github.com/toininoi/cli-printing-press/issues/3024)) ([07d6d24](https://github.com/toininoi/cli-printing-press/commit/07d6d245c2fa311cb17fcccf9b10ecb32f49750e))
* **cli:** skip required-query dependent sync ([#2831](https://github.com/toininoi/cli-printing-press/issues/2831)) ([4d28f0f](https://github.com/toininoi/cli-printing-press/commit/4d28f0ff1d62a7c0a6c28b1e73e74a2adc74a6aa))
* **cli:** skip soft lookup error probes ([#3468](https://github.com/toininoi/cli-printing-press/issues/3468)) ([6037ad2](https://github.com/toininoi/cli-printing-press/commit/6037ad292c4977c4e383d0f96554e3585e9fa9ef))
* **cli:** skip sync/auto-refresh when required params unknown ([#4616](https://github.com/toininoi/cli-printing-press/issues/4616)) ([c134298](https://github.com/toininoi/cli-printing-press/commit/c134298dc1514e4558994ee35d28c635cdf3228d))
* **cli:** speed up generated Windows shellout tests ([#4119](https://github.com/toininoi/cli-printing-press/issues/4119)) ([781a1c7](https://github.com/toininoi/cli-printing-press/commit/781a1c77c86f234cecebbd537c6034b625effe85))
* **cli:** stabilize live-check binary lifecycle ([#3921](https://github.com/toininoi/cli-printing-press/issues/3921)) ([7b0461f](https://github.com/toininoi/cli-printing-press/commit/7b0461faff64e5bff47528d6fb74bd431c613ab0))
* **cli:** stamp printed MCP versions in bundles ([#2817](https://github.com/toininoi/cli-printing-press/issues/2817)) ([e4bc665](https://github.com/toininoi/cli-printing-press/commit/e4bc6654dfc33ffc8a3ac5b540f68c3c6ee0b65e))
* **cli:** stop --force reprint from keeping stale generated bodies ([#4430](https://github.com/toininoi/cli-printing-press/issues/4430)) ([4e3b7a3](https://github.com/toininoi/cli-printing-press/commit/4e3b7a3fc6088e29d51f711273feaa56a83ddc4f))
* **cli:** stop analytics group-by emitting Go nil string ([#4559](https://github.com/toininoi/cli-printing-press/issues/4559)) ([36b8063](https://github.com/toininoi/cli-printing-press/commit/36b8063069d6d1a133e9ad6f9669894a7dc5fe51))
* **cli:** stop baking HAR resource ids into generated defaults ([#4667](https://github.com/toininoi/cli-printing-press/issues/4667)) ([075d098](https://github.com/toininoi/cli-printing-press/commit/075d0986642791db5ff490164fbefe7d112d14a6))
* **cli:** stop doctor from reporting an unverifiable credential probe as ok ([#3716](https://github.com/toininoi/cli-printing-press/issues/3716)) ([be3a0df](https://github.com/toininoi/cli-printing-press/commit/be3a0df1a94e59f2f0c44d80f0afb322fdc865ab))
* **cli:** stop dogfood classifier mislabeling help failures as transport_error ([#3154](https://github.com/toininoi/cli-printing-press/issues/3154)) ([14f97f4](https://github.com/toininoi/cli-printing-press/commit/14f97f42dd39ca324464ab2e77d41cb26d0d2493))
* **cli:** stop generated test fixtures tripping publish secret scan ([#4664](https://github.com/toininoi/cli-printing-press/issues/4664)) ([a475090](https://github.com/toininoi/cli-printing-press/commit/a475090e1599f2d06f94ffb8624abbc70606d4f0))
* **cli:** stop GraphQL false-positives on description prose ([#4486](https://github.com/toininoi/cli-printing-press/issues/4486)) ([c6d4848](https://github.com/toininoi/cli-printing-press/commit/c6d48489fdfc2326682f9c817a15233264a19715))
* **cli:** stop MCP flag smuggling and variadic argv collapse ([#4647](https://github.com/toininoi/cli-printing-press/issues/4647)) ([be378ad](https://github.com/toininoi/cli-printing-press/commit/be378adf964937cda1310006c44ea265a28003ff))
* **cli:** stop name-keying records when a real identifier exists ([#4215](https://github.com/toininoi/cli-printing-press/issues/4215)) ([a6eb395](https://github.com/toininoi/cli-printing-press/commit/a6eb3950b032c7974f79ea194dc22775300db959))
* **cli:** stop selecting missing comm_health workflow template ([#4665](https://github.com/toininoi/cli-printing-press/issues/4665)) ([ffbde99](https://github.com/toininoi/cli-printing-press/commit/ffbde9923f539a8c013cf637d455236dc8a2fa0d))
* **cli:** stop storing nested objects as sync rows ([#4226](https://github.com/toininoi/cli-printing-press/issues/4226)) ([9bac860](https://github.com/toininoi/cli-printing-press/commit/9bac8609f270d7a6f8d9ff130d4b6db739bc33ee))
* **cli:** strip raw sniff captures from packaged manuscripts ([#3033](https://github.com/toininoi/cli-printing-press/issues/3033)) ([f85808e](https://github.com/toininoi/cli-printing-press/commit/f85808e8cadec0da3b017721f8a8b09f8ae93c9b))
* **cli:** strip trailing punctuation from verify-skill flag tokens ([#2964](https://github.com/toininoi/cli-printing-press/issues/2964)) ([4194bef](https://github.com/toininoi/cli-printing-press/commit/4194befbc125847a6960f589d5406157a01a27b7))
* **cli:** strip wrapping quotes from verify-skill prose flag tokens ([#3108](https://github.com/toininoi/cli-printing-press/issues/3108)) ([9555de6](https://github.com/toininoi/cli-printing-press/commit/9555de65a0211a4176f6ff82049bacc321a7c167))
* **cli:** support array request bodies from stdin ([#3484](https://github.com/toininoi/cli-printing-press/issues/3484)) ([956c095](https://github.com/toininoi/cli-printing-press/commit/956c095b9a26ab3fae6ccd4c56da7570c5f29c0c))
* **cli:** support local sqlite specs without base urls ([#2807](https://github.com/toininoi/cli-printing-press/issues/2807)) ([b36e7bc](https://github.com/toininoi/cli-printing-press/commit/b36e7bcca3a3223cfd4cec795075117ded79a467))
* **cli:** support next_token sync pagination ([#2818](https://github.com/toininoi/cli-printing-press/issues/2818)) ([d0a5d24](https://github.com/toininoi/cli-printing-press/commit/d0a5d243af188f32edba40b16d4c54cc1b8d951d))
* **cli:** support OData conditions sync filters ([#3262](https://github.com/toininoi/cli-printing-press/issues/3262)) ([9c62eee](https://github.com/toininoi/cli-printing-press/commit/9c62eee18f9b0174ef437e84c298f8d0db6fa8ee))
* **cli:** support POST HTML table sniffing ([#3347](https://github.com/toininoi/cli-printing-press/issues/3347)) ([a6e7162](https://github.com/toininoi/cli-printing-press/commit/a6e716223af1b94dc967be1bce69caf5e6f1b782))
* **cli:** support structured binary response output ([#3628](https://github.com/toininoi/cli-printing-press/issues/3628)) ([5ed7dfe](https://github.com/toininoi/cli-printing-press/commit/5ed7dfe56aa0237f8ded8bd3058fec2aabb511ce))
* **cli:** suppress scorer verifier false positives ([#3272](https://github.com/toininoi/cli-printing-press/issues/3272)) ([ce71036](https://github.com/toininoi/cli-printing-press/commit/ce71036a222180a50295ffa10cdd6a73c30db761))
* **cli:** surface success-path CLI stderr to MCP clients ([#4225](https://github.com/toininoi/cli-printing-press/issues/4225)) ([8136196](https://github.com/toininoi/cli-printing-press/commit/813619660c7117a75a49ddc8142af488bf130d9e))
* **cli:** sync --dry-run must not mutate sync_state (dependent resources + cursor clears) ([#2946](https://github.com/toininoi/cli-printing-press/issues/2946)) ([a27740e](https://github.com/toininoi/cli-printing-press/commit/a27740eb474c9424857b032614be93009c581d00))
* **cli:** sync narrative docs and MCP descriptions ([#3346](https://github.com/toininoi/cli-printing-press/issues/3346)) ([76490b8](https://github.com/toininoi/cli-printing-press/commit/76490b83e8a1795bd1a14250baf52ba0ef032080))
* **cli:** synthesize happy-args instead of TODO examples ([#4650](https://github.com/toininoi/cli-printing-press/issues/4650)) ([48082db](https://github.com/toininoi/cli-printing-press/commit/48082dbd14401cded04f6f8c0a5518e8168b65f4))
* **cli:** synthesize html page sync ids ([#2835](https://github.com/toininoi/cli-printing-press/issues/2835)) ([88617bb](https://github.com/toininoi/cli-printing-press/commit/88617bb94d0271bc031af50b49935bda8cfe5fff))
* **cli:** tenant cache key, runnable doctor reads, query-param dependents ([#4489](https://github.com/toininoi/cli-printing-press/issues/4489)) ([0282159](https://github.com/toininoi/cli-printing-press/commit/0282159de3a65e70b6be3cc4f55d953483b3f48a))
* **cli:** tolerate npm download response shapes ([#3883](https://github.com/toininoi/cli-printing-press/issues/3883)) ([deb13ad](https://github.com/toininoi/cli-printing-press/commit/deb13ada8cb613e0339339cf463fd63f4538b3fe))
* **cli:** tolerate vanished entries during --force fresh-tree backup ([#4475](https://github.com/toininoi/cli-printing-press/issues/4475)) ([3a397e2](https://github.com/toininoi/cli-printing-press/commit/3a397e2d3e1d65e098fdd70f4194f2c8ef1d0398))
* **cli:** treat HTTP 200 ok:false envelopes as sync failures ([#4269](https://github.com/toininoi/cli-printing-press/issues/4269)) ([8944db4](https://github.com/toininoi/cli-printing-press/commit/8944db4a81c1d1a67d99f5e52db9b96ae340e000)), closes [#3956](https://github.com/toininoi/cli-printing-press/issues/3956)
* **cli:** treat nested help as success ([#3289](https://github.com/toininoi/cli-printing-press/issues/3289)) ([f4f125d](https://github.com/toininoi/cli-printing-press/commit/f4f125d1856449232fec5501f72967755f5802fd))
* **cli:** treat unclassified dogfood commands as mutating ([#4193](https://github.com/toininoi/cli-printing-press/issues/4193)) ([ca3a6dd](https://github.com/toininoi/cli-printing-press/commit/ca3a6dd33ed4c087f319606bab09231bb6716be4))
* **cli:** treat zero sync times as never synced ([#4426](https://github.com/toininoi/cli-printing-press/issues/4426)) ([d90249c](https://github.com/toininoi/cli-printing-press/commit/d90249cf97f53623e5084b7ba564861a499d1b2e))
* **cli:** truncate on rune boundaries ([#4442](https://github.com/toininoi/cli-printing-press/issues/4442)) ([2951760](https://github.com/toininoi/cli-printing-press/commit/2951760c970818b689d9a5370c79e07b3b1226eb))
* **cli:** unify generated agent envelopes ([#3260](https://github.com/toininoi/cli-printing-press/issues/3260)) ([49f2111](https://github.com/toininoi/cli-printing-press/commit/49f21113817ee895295572ea857393f3b493c8d5))
* **cli:** unwrap HAL embedded sync envelopes ([#3114](https://github.com/toininoi/cli-printing-press/issues/3114)) ([8622b62](https://github.com/toininoi/cli-printing-press/commit/8622b621bb3965975e01af784f9fd099a81fb663))
* **cli:** use authoritative resource paths for data commands ([#3661](https://github.com/toininoi/cli-printing-press/issues/3661)) ([2621ebc](https://github.com/toininoi/cli-printing-press/commit/2621ebcde49b435ee105de7135841c366f699412))
* **cli:** use default page size for bare --all offset pagination ([#3519](https://github.com/toininoi/cli-printing-press/issues/3519)) ([d33b276](https://github.com/toininoi/cli-printing-press/commit/d33b276d8b9f96a98237a8256644106348749bda))
* **cli:** use non-ticker alias fixture in learn teach test ([#4409](https://github.com/toininoi/cli-printing-press/issues/4409)) ([a3896a2](https://github.com/toininoi/cli-printing-press/commit/a3896a2866af7f638a9c600006336070bd85c29e))
* **cli:** use schema hints in generated examples ([#2874](https://github.com/toininoi/cli-printing-press/issues/2874)) ([175105f](https://github.com/toininoi/cli-printing-press/commit/175105f2be66a2afeaa118cad903f3db7e608789))
* **cli:** use unstamped generated CLI version defaults ([#3524](https://github.com/toininoi/cli-printing-press/issues/3524)) ([d09a23b](https://github.com/toininoi/cli-printing-press/commit/d09a23b456f372b24a3a34e6a53c79a5216e22f1))
* **cli:** validate composed-auth login --chrome sessions ([#4207](https://github.com/toininoi/cli-printing-press/issues/4207)) ([6a54174](https://github.com/toininoi/cli-printing-press/commit/6a54174c5ea82fc0e34d0065c3d5d0bd5d450d88))
* **cli:** validate generated unit tests ([#3748](https://github.com/toininoi/cli-printing-press/issues/3748)) ([9cb9fe6](https://github.com/toininoi/cli-printing-press/commit/9cb9fe6940e60153bdbf041f2a4f159cc77d5442))
* **cli:** validate go.mod module path and surface Greptile gate contract ([#4049](https://github.com/toininoi/cli-printing-press/issues/4049)) ([9be6a75](https://github.com/toininoi/cli-printing-press/commit/9be6a750fb1a5af91413c3d9b4211fef7014f8f7))
* **cli:** validate JSON body flag shapes ([#3647](https://github.com/toininoi/cli-printing-press/issues/3647)) ([f232a7b](https://github.com/toininoi/cli-printing-press/commit/f232a7b6839a879a53e912cae35c460145c58a82))
* **cli:** validate learn ticker_patterns against playbook examples ([#4633](https://github.com/toininoi/cli-printing-press/issues/4633)) ([536e156](https://github.com/toininoi/cli-printing-press/commit/536e15657c68d19a4bc1359567a901bb58f1e980))
* **cli:** verify generated TLS certificates by default ([#3605](https://github.com/toininoi/cli-printing-press/issues/3605)) ([18022d9](https://github.com/toininoi/cli-printing-press/commit/18022d9e44d4d6eb29de136cd20718875631a0e9))
* **cli:** verify-skill detects alias-receiver flags and fixes positional/flag-value tokenization ([#2692](https://github.com/toininoi/cli-printing-press/issues/2692)) ([6a98b16](https://github.com/toininoi/cli-printing-press/commit/6a98b163541cce72d41d24387602034a402ce9e5))
* **cli:** wait for rate-limit budget instead of failing ([#4441](https://github.com/toininoi/cli-printing-press/issues/4441)) ([bdcda55](https://github.com/toininoi/cli-printing-press/commit/bdcda558102a9336bc25847a7cae909764c8d690))
* **cli:** warn on unenriched promote manifests ([#2871](https://github.com/toininoi/cli-printing-press/issues/2871)) ([3c14fcb](https://github.com/toininoi/cli-printing-press/commit/3c14fcbe21be17a1bbdd868ec680335ecc8642a6))
* **cli:** warn on unknown --select fields ([#3652](https://github.com/toininoi/cli-printing-press/issues/3652)) ([620ea2f](https://github.com/toininoi/cli-printing-press/commit/620ea2fb340e7c12a84dfc06a96cf8b029d1a9a8))
* **cli:** warn or carry templated hand-edits on cross-spec --force ([#4299](https://github.com/toininoi/cli-printing-press/issues/4299)) ([f094593](https://github.com/toininoi/cli-printing-press/commit/f0945937066741b0027fba91ddd4da7d271d1c04))
* **cli:** Windows auth remedy and cookies-file help ([#4508](https://github.com/toininoi/cli-printing-press/issues/4508)) ([49fbda4](https://github.com/toininoi/cli-printing-press/commit/49fbda4f4b1f4529db85e7e07bafccbafb12db21))
* **cli:** wire seeded cookie jar for cookie-auth client transport ([#3106](https://github.com/toininoi/cli-printing-press/issues/3106)) ([0a89d57](https://github.com/toininoi/cli-printing-press/commit/0a89d57c43be4cba314e1d551a9e3188a8ba9b83))
* **cli:** wire stdin fixtures through verification ([#4136](https://github.com/toininoi/cli-printing-press/issues/4136)) ([a6923ce](https://github.com/toininoi/cli-printing-press/commit/a6923ceb253d4ee15562baa95b52f6fc462aa86b))
* **cli:** wrap mutation bodies under spec resource root. ([#4246](https://github.com/toininoi/cli-printing-press/issues/4246)) ([3ab775b](https://github.com/toininoi/cli-printing-press/commit/3ab775be0125416309f705e4670041e321f98d66))
* **dogfood:** parse backslash-continuation example blocks as one command ([#4013](https://github.com/toininoi/cli-printing-press/issues/4013)) ([da28789](https://github.com/toininoi/cli-printing-press/commit/da287893e17b64c4bcfabb1d05c38f911ed5d6e6))
* **dogfood:** skip top-level login alias in live dogfood matrix ([#3073](https://github.com/toininoi/cli-printing-press/issues/3073)) ([2d2860b](https://github.com/toininoi/cli-printing-press/commit/2d2860b3cee8a89fd19e4a400f79b54b3e2de684))
* **generator:** add missing Example to feedback command template ([#4290](https://github.com/toininoi/cli-printing-press/issues/4290)) ([bd9fab0](https://github.com/toininoi/cli-printing-press/commit/bd9fab0ab8955a310d73080e3ff2208212f09526))
* **generator:** auto-detect all Chrome channels in auth login --chrome ([#3528](https://github.com/toininoi/cli-printing-press/issues/3528)) ([3f11b8d](https://github.com/toininoi/cli-printing-press/commit/3f11b8d1fbd9e23ee13978177d603d267c7883cc))
* **generator:** don't persist env-sourced credentials into config.toml ([#2710](https://github.com/toininoi/cli-printing-press/issues/2710)) ([#2720](https://github.com/toininoi/cli-printing-press/issues/2720)) ([b63fb35](https://github.com/toininoi/cli-printing-press/commit/b63fb3555650451e5e659b29f8c91f915e04c1a4))
* **generator:** fail-closed mcp:read-only for GET RPCs without a mutation signal ([#4361](https://github.com/toininoi/cli-printing-press/issues/4361)) ([401a590](https://github.com/toininoi/cli-printing-press/commit/401a590827f7fb30dfe2fb724a135f7b985763fb))
* **generator:** harden resumable pagination checkpoints ([#4675](https://github.com/toininoi/cli-printing-press/issues/4675)) ([9372b50](https://github.com/toininoi/cli-printing-press/commit/9372b50b7c8f9c624d7afcba2a9f0361673072c0))
* **generator:** honor patch records across regen ([#4332](https://github.com/toininoi/cli-printing-press/issues/4332)) ([54ad99e](https://github.com/toininoi/cli-printing-press/commit/54ad99eb68385245f2cff1b3f7c7880813d84472))
* **generator:** make internal/platform permission checks portable to Windows ([#3995](https://github.com/toininoi/cli-printing-press/issues/3995)) ([d2dc9b4](https://github.com/toininoi/cli-printing-press/commit/d2dc9b4fb64190acb348e502703c8712bce241ef))
* **generator:** make store list zero limit unlimited ([#2757](https://github.com/toininoi/cli-printing-press/issues/2757)) ([276c76c](https://github.com/toininoi/cli-printing-press/commit/276c76c9ee8ac7c6de42a983d1928b6f61fd2196))
* **generator:** mark generated security suppressions ([#3485](https://github.com/toininoi/cli-printing-press/issues/3485)) ([f05a0fd](https://github.com/toininoi/cli-printing-press/commit/f05a0fdf6d03fc1bb346bfd5f758d18bb91cd311))
* **generator:** mark tail command no-error-path-probe ([#2969](https://github.com/toininoi/cli-printing-press/issues/2969)) ([13cd7d0](https://github.com/toininoi/cli-printing-press/commit/13cd7d0dd842c74461036c2ac31fd326df0be787)), closes [#2968](https://github.com/toininoi/cli-printing-press/issues/2968)
* **generator:** omit optional query params with empty/invalid spec defaults; trim enum tokens ([#3077](https://github.com/toininoi/cli-printing-press/issues/3077)) ([920f7e2](https://github.com/toininoi/cli-printing-press/commit/920f7e2080de8bdb7002a6107a969c9fa9bcd215))
* **generator:** owner-only DACL on emitted testenv sandbox for Windows ([#3855](https://github.com/toininoi/cli-printing-press/issues/3855)) ([67eb007](https://github.com/toininoi/cli-printing-press/commit/67eb007c1845b2ddbdaa568d48008d14b598e594))
* **generator:** pick docs examples by method, not alphabetical order ([#3998](https://github.com/toininoi/cli-printing-press/issues/3998)) ([8c112a2](https://github.com/toininoi/cli-printing-press/commit/8c112a2ad1c5ed7118f4d968a09b24ab42fdb0ab))
* **generator:** prevent sync data-loss defaults ([#2760](https://github.com/toininoi/cli-printing-press/issues/2760)) ([4ba4967](https://github.com/toininoi/cli-printing-press/commit/4ba496719efde7a8ba24768a00a77a824a729c37))
* **generator:** propagate export flush and sync SaveSyncState errors ([#3857](https://github.com/toininoi/cli-printing-press/issues/3857)) ([a749125](https://github.com/toininoi/cli-printing-press/commit/a7491259a21cf768f98f3cb0ca64f34b13dda84e))
* **generator:** qualify FTS ORDER BY rank ([#3023](https://github.com/toininoi/cli-printing-press/issues/3023)) ([46a5e97](https://github.com/toininoi/cli-printing-press/commit/46a5e978fd74b4b9104aacd70d5bf41dc14c5d28)), closes [#2973](https://github.com/toininoi/cli-printing-press/issues/2973)
* **generator:** refresh authorization-code bearer auth ([#3064](https://github.com/toininoi/cli-printing-press/issues/3064)) ([0e7ecc5](https://github.com/toininoi/cli-printing-press/commit/0e7ecc59d15c77c599f2d3e20b9b4a65465524c6))
* **generator:** reject empty positional path-param values with a clear error ([#3087](https://github.com/toininoi/cli-printing-press/issues/3087)) ([383eb6d](https://github.com/toininoi/cli-printing-press/commit/383eb6d78e4e13bb9213e99d1f8aa95e5c75bbe6))
* **generator:** reject malformed cookie imports ([#3707](https://github.com/toininoi/cli-printing-press/issues/3707)) ([7cd1cf6](https://github.com/toininoi/cli-printing-press/commit/7cd1cf6fc1b894776ac7495a0f82e9cc0276eeee))
* **generator:** scope cursor zero-strip exemption to offset pagination ([#4003](https://github.com/toininoi/cli-printing-press/issues/4003)) ([eab2f62](https://github.com/toininoi/cli-printing-press/commit/eab2f62935c062f6553a5dd5298148594f733541))
* **generator:** stat real default DB path in teach isolation test ([#3856](https://github.com/toininoi/cli-printing-press/issues/3856)) ([0be6b79](https://github.com/toininoi/cli-printing-press/commit/0be6b79528cacb8cbd7b01fec44685f03c9373d2)), closes [#3853](https://github.com/toininoi/cli-printing-press/issues/3853)
* **generator:** stop mid-word truncation of root Short/Long ([#3363](https://github.com/toininoi/cli-printing-press/issues/3363)) ([6c4d9c4](https://github.com/toininoi/cli-printing-press/commit/6c4d9c43a403f29b07dead04832d3d5db6ec97d2))
* **mcp,auth:** require HTTP MCP caller auth and stdin set-token ([#4360](https://github.com/toininoi/cli-printing-press/issues/4360)) ([f2dc1e5](https://github.com/toininoi/cli-printing-press/commit/f2dc1e5213656b47daaeab0e50cce08d588bf5d9))
* **mcp:** include internal/config env reads in manifest operator declaration ([#4377](https://github.com/toininoi/cli-printing-press/issues/4377)) ([56e2e46](https://github.com/toininoi/cli-printing-press/commit/56e2e46b8decb11fcca246b7c6f45ec04250fe08))
* **openapi:** classify array-root multipart bodies so file upload works ([#3999](https://github.com/toininoi/cli-printing-press/issues/3999)) ([f34bed6](https://github.com/toininoi/cli-printing-press/commit/f34bed644dc23c1d2fc4d40cceb8254e15c5b20b))
* **output-review:** skip when no samples pass ([#3805](https://github.com/toininoi/cli-printing-press/issues/3805)) ([de9464e](https://github.com/toininoi/cli-printing-press/commit/de9464e6c94587fab32a14472ac9bc1e5ad2c4fb))
* **polish:** count _test.go references and compile test binaries before verifying ([#3996](https://github.com/toininoi/cli-printing-press/issues/3996)) ([ccfd51d](https://github.com/toininoi/cli-printing-press/commit/ccfd51d97bc36f7207a90ed59e665ec49a06134a))
* **profiler:** stop using page-size defaults as sync pageSize ([#4380](https://github.com/toininoi/cli-printing-press/issues/4380)) ([86c6b3d](https://github.com/toininoi/cli-printing-press/commit/86c6b3d76b82705a8f872b4a72bf2166204970b4))
* **schema:** make phase5-acceptance schema describe what the runner emits ([#3997](https://github.com/toininoi/cli-printing-press/issues/3997)) ([c309253](https://github.com/toininoi/cli-printing-press/commit/c309253680501b84fbdc53a15e12522089b316d7))
* **skill:** detect installed skill drift after binary upgrades ([#4628](https://github.com/toininoi/cli-printing-press/issues/4628)) ([0260d68](https://github.com/toininoi/cli-printing-press/commit/0260d68603edcb7b5d5253c497fcfc67ae47ac43))
* **skills:** add blocked API journal flow ([#2806](https://github.com/toininoi/cli-printing-press/issues/2806)) ([7d445b1](https://github.com/toininoi/cli-printing-press/commit/7d445b1f5bb95c5ec54486c7ab07760ffa59a632))
* **skills:** add sqlite missing-mirror guard guidance ([#2819](https://github.com/toininoi/cli-printing-press/issues/2819)) ([393347a](https://github.com/toininoi/cli-printing-press/commit/393347a2449a24dbc2f0aae71609df1a35b37a22))
* **skills:** block proposal PR fallback for real artifact work ([#3412](https://github.com/toininoi/cli-printing-press/issues/3412)) ([95636bf](https://github.com/toininoi/cli-printing-press/commit/95636bff0c83ccfc90f27aa1ec153240a99ac207))
* **skills:** guard publish reprint workflows ([#3266](https://github.com/toininoi/cli-printing-press/issues/3266)) ([5c3d695](https://github.com/toininoi/cli-printing-press/commit/5c3d69509ab60f0423871572ccccb64c8dbe67ff))
* **skills:** harden retro artifact upload gates ([#4079](https://github.com/toininoi/cli-printing-press/issues/4079)) ([b68142d](https://github.com/toininoi/cli-printing-press/commit/b68142db8d9453109ab5151e7dc873ab8c1ee35d))
* **skills:** harden skill flow scope and CRLF handling ([#3330](https://github.com/toininoi/cli-printing-press/issues/3330)) ([7e56e63](https://github.com/toininoi/cli-printing-press/commit/7e56e6376bd9fe6fc58209ed005d59d437939085))
* **skills:** make run ids collision-proof ([#2759](https://github.com/toininoi/cli-printing-press/issues/2759)) ([c262d56](https://github.com/toininoi/cli-printing-press/commit/c262d56a08de1460d0727922309ccd63c5cc6d55))
* **skills:** migrate retro issue taxonomy labels ([#3937](https://github.com/toininoi/cli-printing-press/issues/3937)) ([2fab24e](https://github.com/toininoi/cli-printing-press/commit/2fab24eb167bc2e8a76467fca9dd1689ba4138ef))
* **skills:** Phase 0 registry lookup uses schema v2 .entries key ([#3608](https://github.com/toininoi/cli-printing-press/issues/3608)) ([50521b1](https://github.com/toininoi/cli-printing-press/commit/50521b184de7a4a851594a62e69ec4bab6eba9a3))
* **skills:** preflight Go currency and disk space ([#3409](https://github.com/toininoi/cli-printing-press/issues/3409)) ([ff9e58e](https://github.com/toininoi/cli-printing-press/commit/ff9e58e85b19190ec7905e7c89f017bbbdeaf4d4))
* **skills:** preserve runtime version layout on reprints ([#3578](https://github.com/toininoi/cli-printing-press/issues/3578)) ([9b81492](https://github.com/toininoi/cli-printing-press/commit/9b81492424fb46245fda0310fe39f8cdc515672c))
* **skills:** raise supported version floor ([#3498](https://github.com/toininoi/cli-printing-press/issues/3498)) ([3b1f7c3](https://github.com/toininoi/cli-printing-press/commit/3b1f7c3f1cf67fa5caf397f1f89eee4d72097577))
* **skills:** rebuild stale repo preflight binary ([#2810](https://github.com/toininoi/cli-printing-press/issues/2810)) ([cfe9e8f](https://github.com/toininoi/cli-printing-press/commit/cfe9e8ffda9516181e7faaec48fadb2d8646cdb9))
* **skills:** refuse physical side effects under every harness ([#4203](https://github.com/toininoi/cli-printing-press/issues/4203)) ([a5400a4](https://github.com/toininoi/cli-printing-press/commit/a5400a4627ceddb15c9057d99c8fa9dcf13d239e))
* **skills:** remove positional params from preflight blocks ([#3871](https://github.com/toininoi/cli-printing-press/issues/3871)) ([1224726](https://github.com/toininoi/cli-printing-press/commit/122472602931a64fb48cde7ff4969bdd1682ad42))
* **skills:** resolve amend publish status by slug ([#3032](https://github.com/toininoi/cli-printing-press/issues/3032)) ([147119f](https://github.com/toininoi/cli-printing-press/commit/147119f56adb8c59515868a0e29a544e0f81179c))
* **skills:** route description review fixes through research ([#3386](https://github.com/toininoi/cli-printing-press/issues/3386)) ([4407f1a](https://github.com/toininoi/cli-printing-press/commit/4407f1a899efd8c9e0e13570e64dc80eb5d28761))
* skip permission test on Windows where Getuid is unsupported ([#2900](https://github.com/toininoi/cli-printing-press/issues/2900)) ([b3fbb2e](https://github.com/toininoi/cli-printing-press/commit/b3fbb2ec8c119d022b7f35e2dd49fba31fff6853))
* **store:** nested/id_/unusable record-ID resolution ([#4379](https://github.com/toininoi/cli-printing-press/issues/4379)) ([2c57c2e](https://github.com/toininoi/cli-printing-press/commit/2c57c2ed55002e48baae54c094b47e7c609ff09d))
* **store:** stop concurrent-reader SIGBUS on WAL-index mmap ([#4359](https://github.com/toininoi/cli-printing-press/issues/4359)) ([74fea21](https://github.com/toininoi/cli-printing-press/commit/74fea21796b9ba76a206ca007133aa0ecf0770c5))
* **substack:** route draft writer endpoints globally ([#3191](https://github.com/toininoi/cli-printing-press/issues/3191)) ([36c4be0](https://github.com/toininoi/cli-printing-press/commit/36c4be02130544effc0673d2a0e33e22df01adc2))
* **sync:** honor per-endpoint base_url overrides ([#4331](https://github.com/toininoi/cli-printing-press/issues/4331)) ([3cd6cba](https://github.com/toininoi/cli-printing-press/commit/3cd6cba04899430a1cb2e4911de8d7270875c595))
* **test:** drain captured stdout pipe to prevent deadlock ([#3072](https://github.com/toininoi/cli-printing-press/issues/3072)) ([69915cd](https://github.com/toininoi/cli-printing-press/commit/69915cd00edc6ad803d43a6733a831db1a3fa496))
* **windows:** generated CLIs could neither build nor test on Windows ([#4106](https://github.com/toininoi/cli-printing-press/issues/4106)) ([deb0b07](https://github.com/toininoi/cli-printing-press/commit/deb0b070f7672e4a892164d716fa75c850e4f5ee))


### Code Refactoring

* **cli:** remove embedded catalog ([#3385](https://github.com/toininoi/cli-printing-press/issues/3385)) ([74fcff8](https://github.com/toininoi/cli-printing-press/commit/74fcff8ddc06e21925829096849ad07df7ca31b0))
...
* **cli:** accept x-tenant-env-var/x-path-template-env-vars at doc root ([#4573](https://github.com/mvanhorn/cli-printing-press/issues/4573)) ([79b74f2](https://github.com/mvanhorn/cli-printing-press/commit/79b74f2e947a4da78cc10185ff932d67447fc009))
* **cli:** enable verify live mode from explicit --env-var ([#4606](https://github.com/mvanhorn/cli-printing-press/issues/4606)) ([6b9914b](https://github.com/mvanhorn/cli-printing-press/commit/6b9914bc9c861b4daabdedd7c92191e6b054b6fd))
...
* **cli:** persist rotating refresh tokens across live dogfood ([#4594](https://github.com/mvanhorn/cli-printing-press/issues/4594)) ([92b601d](https://github.com/mvanhorn/cli-printing-press/commit/92b601dcb2c9050d4cca5dd381d661b0eeb2e5ca))
...
* **cli:** scrub JWT-form GitHub installation tokens ([#4607](https://github.com/mvanhorn/cli-printing-press/issues/4607)) ([d63da1e](https://github.com/mvanhorn/cli-printing-press/commit/d63da1ef71b4271460178bc0ed38b9194befa9cc))
